...
//
//----------------------------------------------------------------------------------------------------
//#define _PANNEL_NAME                            _A_,_U_,_O_,_,_M_,_2_,_7_,_0_,_D_,_A_,_N_,_0_,_2_

//--------------------------------------------------
// Definitions for EDID SEL
//--------------------------------------------------
...
#define _PANEL_MAX_FRAME_RATE                   1750
...
//--------------------------------------------------
#define _PANEL_FREESYNC_MAX_FRAME_RATE          1750
...
#define _LVDS_PANEL_SECTION                     _LVDS_PANEL_2_SECTION
  ...
  #define _PNL_LVDS_PORT_MIRROR                       _DISABLE
#define _PNL_LVDS_PORT_LMIRROR                      _ENABLE
#define _PNL_LVDS_PORT_AB_SWAP                      _DISABLE
#define _PNL_LVDS_PORT_CD_SWAP                      _DISABLE
#define _PNL_LVDS_PORT_EF_SWAP                      _DISABLE
#define _PNL_LVDS_PORT_GH_SWAP                      _DISABLE
#define _PNL_LVDS_PN_SWAP                           _DISABLE
 #define _PNL_LVDS_PORT_HL_MIRROR                       _DISABLE
...
#define _PANEL_DH_TOTAL                         2880                // Display Horizontal Total Clock Number in One Display Line
#define _PANEL_DH_TOTAL_MAX                     4168                // Maxinum Display Horizontal Total Clock Number in One Display Line
...
#define _PANEL_DV_TOTAL_MAX                     8000                // Maxinum Display Vertical Total Clock Number in One Display Line
...
#define _PANEL_PIXEL_CLOCK                      540                 // Typical Pixel Clock in MHz
#define _PANEL_PIXEL_CLOCK_MAX                  750                 // Maxinum Pixel Clock in MHz
#define _PANEL_PIXEL_CLOCK_MIN                  240                 // Mininum Pixel Clock in MHz
...
#endif // End of #if(_PANEL_TYPE == _AUO_M270DAN02_8CH_LVDS)
//----------------------------------------------------------------------------------------------------
