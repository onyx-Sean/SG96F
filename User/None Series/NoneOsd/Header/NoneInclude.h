...
extern void OsdDispMainMenuSubSelect(BYTE ucItem, BYTE ucOsdState, BYTE ucOsdStatePrevious);
extern void OsdDispMainMenuCursor(BYTE ucOsdState, BYTE ucOsdStatePrevious, bit bInSubsidiary);
