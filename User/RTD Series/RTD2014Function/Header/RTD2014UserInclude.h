...
#if((_OSD_TYPE == _REALTEK_2014_OSD) || (_TWO_CHIP_TRANSLATOR_CHIP_SHOW_PICTURE_SUPPORT == _ON))
...
#if(_CONTRAST_SUPPORT == _ON)
extern void UserAdjustHdrContrast(WORD usContrast);
#endif
...
extern WORD UserInterfaceLedDriverPWMSmoothLevel(void);
extern bit UserInterfaceGetLocalDimmingOSD(void);
#if(_ULTRA_HDR_SUPPORT == _ON)
...
extern void COsdShowPageInputTextSelect(BYTE InputOsd,BYTE InputType,BYTE NUM);
