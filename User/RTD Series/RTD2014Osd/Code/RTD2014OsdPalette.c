...
#define _RGB_GREEN_119                            0,  255,  0     
#define _RGB_BLUE                                 0,  181,  181
#define _RGB_YELLOW                             255, 255,   0
#define _RGB_BLACK_1                              0,     0,   0
#if(_OSD_HHT==_OFF)
#define _RGB_BLUE_65                              255, 255, 255
#else
#define _RGB_BLUE_65                           247, 90,  40//   0,   0,  65
#endif
#define _RGB_GRAY                             96,   96,  96
#define _RGB_LIGHTBLUE                          208, 208, 208
#define _RGB_SELECTBOTTOM                       58,   70,  80
#define _RGB_PINK                               255, 128, 255
#define _RGB_GREEN_1                   0,  255,  0       
#define _RGB_ORANGE_H                           250, 180,  40
#define _RGB_ORANGE_DARK                      224, 120,   7
#define _RGB_GRAY_1                             0,     0,   0
#define    _RGB_BLUE_120                  0,   0,  120
...
#define _LOGO_RED1                                200,   0,   0
#else
#define _LOGO_RED1                                247, 90,  40//  255,   0,   0
#endif
#if(_OSD_LOGO_TYPE ==  _NEWSKILL_LOGO)
#define _LOGO_ORANGE_H                           0, 169,  224
#define _LOGO_ORANGE_L                          169, 169,   171
#else
#define _LOGO_ORANGE_H                           247, 90,  40
