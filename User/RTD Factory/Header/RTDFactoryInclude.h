...
#define _PFONT_FACTORY_OSD_DOUBLE_ON_OFF            _PFONT_FACTORY_PAGE_ITEM_13

#define _FACTORY_PAGE_0_START                       0x01
#define _FACTORY_PAGE_0_END                         0xC0//0xA0

#define _FACTORY_PAGE_1_START                       0xC1//0xA1
...
#define _FACTORY_CHECKSUM_ROW                     	2
...
#endif
extern void SGFactoryShowBurninPicture(void);

extern WORD ISP_Check_Bank0_Sum();
extern WORD ISP_Check_Bank1_Sum();
extern WORD ISP_Check_Bank2_Sum();
extern WORD ISP_Check_Bank3_Sum();
extern WORD ISP_Check_Bank4_Sum();
extern WORD ISP_Check_Bank5_Sum();
extern WORD ISP_Check_Bank6_Sum();
extern WORD ISP_Check_Bank7_Sum();

extern void RTDFactoryOsdFuncShowChecksum(BYTE ucRow, BYTE ucCol, DWORD usValue, BYTE ucPar ,BYTE ucFontPoint);
