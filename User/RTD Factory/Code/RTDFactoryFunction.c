...
// DEFINITIONS / MACROS
//****************************************************************************
#define _MAIN_PAGE_MODEL_NAME               _M_,_o_,_d_,_e_,_l_,_,_COLON_,_,_R_,_T_,_D_,_2_,_7_,_9_,_6_
//#define _PANNEL_NAME                        _P_,_a_,_n_,_e_,_l_,_,_COLON_,_,_A_,_U_,_O_
#define _PANNEL_NAME                            _A_,_U_,_O_,_,_M_,_2_,_7_,_0_,_D_,_A_,_N_,_1_,_2_
...
#define _FACTORY_COLORTEMP_TEXT1           _6_,_5_,_0_,_0_//  _9_,_3_,_0_,_0_
...
#define _FACTORY_COLORTEMP_TEXT4            _U_,_s_,_e_,_r_
...
BYTE code tsOSD_FACTORY_CHECKSUM[] =
{
    _C_, _h_, _e_, _c_,_k_, _s_, _u_, _m_,_,_COLON_,_, _END_,
};
...
{
    _N_,_e_,_x_,_t_,_,_P_,_a_,_g_,_e_,_END_,
};
...
{
    _L_,_V_,_D_,_S_,_,_C_,_l_,_o_,_c_,_k_,_,_D_,_r_,_i_,_v_,_i_,_n_,_g_,_END_,
};

BYTE code tsOSD_FACTORY_LVDS_DATA[] =
{
    _L_,_V_,_D_,_S_,_,_D_,_a_,_t_,_a_,_,_D_,_r_,_i_,_v_,_i_,_n_,_g_,_END_,
};
...
{
    _D_,_P_,_,_H_,_o_,_t_,_,_P_,_l_,_u_,_g_,_,_O_,_f_,_f_,_,_H_,_i_,_g_,_h_,_END_,
};

BYTE code tsOSD_FACTORY_HOT_PLUG_HDMI_SUPPORT[] =
{
    _H_,_D_,_M_,_I_,_,_H_,_o_,_t_,_,_P_,_l_,_u_,_g_,_END_,
};

BYTE code tsOSD_FACTORY_HOT_PLUG_HDMI_SUPPORT_TIME[] =
{
    _H_,_o_,_t_,_,_P_,_l_,_u_,_g_,_T_,_i_,_m_,_e_,_LEFT_BRACE_,_1_,_0_,_0_,_m_,_s_,_RIGHT_BRACE_,_END_,
};
BYTE code tsOSD_FACTORY_DP_AUX_MODE[] =
{
    _D_,_P_,_,_A_,_U_,_X_,_,_D_,_i_,_f_,_f_,_,_M_,_o_,_d_,_e_,_END_,
};
BYTE code tsOSD_DOUBLE_SIZE[] =
{
    _O_,_S_,_D_,_,_S_,_i_,_z_,_e_,_X_,_2_,_END_,
};
...
#endif
void SGFactoryShowBurninPicture(void);
...
// Output Value : None
//--------------------------------------------------
void BURN_TIME_PROC(void)
{

     SET_BURN_TIME_MIN(GET_BURN_TIME_MIN()+1);
   ...
   if(GET_BURN_TIME_MIN() >= 60)
   {
        SET_BURN_TIME_MIN(0);

     SET_BURN_TIME_HOUR(GET_BURN_TIME_HOUR()+1);
   }
    ...
    else
    {
        ...
        {
            RTDFactoryOsdFuncShowNumber(ROW(_FACTORY_BURNIN_TIME_ROW), COL(_FACTORY_BURNIN_TIME_HOUR_NUMBER_COL), GET_BURN_TIME_HOUR(), (_ALIGN_LEFT | _FORCE_SHOW_NUMBER_OFF | _SHOW_5), _PFONT_FACTORY_BURNIN_TIME_HOUR);
            RTDFactoryOsdFuncShowNumber(ROW(_FACTORY_BURNIN_TIME_ROW), COL(_FACTORY_BURNIN_TIME_MIN_NUMBER_COL), GET_BURN_TIME_MIN(), (_ALIGN_LEFT | _FORCE_SHOW_NUMBER_OFF | _SHOW_3), _PFONT_FACTORY_BURNIN_TIME_MIN);
        }
        RTDNVRamSavePanelUsedTimeData();
    }
...
void RTDFactoryOsdFuncShowChecksum(BYTE ucRow, BYTE ucCol, DWORD usValue, BYTE ucPar ,BYTE ucFontPoint)
{
    BYTE h,l,t,h1,l1;
    ...
    if((bit)(ucPar & 0x01))        
    {
        RTDFactoryOsdFuncPutStringProp(ucRow, ROW(ucCol-ucTemp), ucFontPoint, tFONT_FACTORY_EUROPE, &pData[8], _ENGLISH);        
    }
    else
    {
        RTDFactoryOsdFuncPutStringProp(ucRow, ucCol, ucFontPoint, tFONT_FACTORY_EUROPE, &pData[8], _ENGLISH);            
    }
}
