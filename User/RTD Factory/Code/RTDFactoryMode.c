...
// DEFINITIONS / MACROS
//****************************************************************************
#define _OSD_FACTORY_PAGE_1_TABLE_END 10
...
void RTDFactoryMainMenu(void)
{
	...
	UserCommonFlashRead(1, 0xfffe, 2, (BYTE *)&g_ucChecksum);
	...
	RTDFactoryOsdFuncPutStringProp(ROW(_FACTORY_FW_VERSION_ROW), COL(_FACTORY_FUNCTION_COL), _PFONT_FACTORY_PAGE_0, tFONT_FACTORY_EUROPE, tOSD_FACTORY_PAGE_TABLE[2], _ENGLISH);    
	RTDFactoryOsdFuncPutStringProp(ROW(_FACTORY_CHECKSUM_ROW), COL(_FACTORY_FUNCTION_COL+11), _PFONT_FACTORY_PAGE_0, tFONT_FACTORY_EUROPE, tOSD_FACTORY_PAGE_TABLE[21], _ENGLISH);
	RTDFactoryOsdFuncShowChecksum(ROW(_FACTORY_CHECKSUM_ROW), COL(_FACTORY_FUNCTION_COL + 18), g_ucChecksum, (_ALIGN_LEFT | _FORCE_SHOW_NUMBER_OFF | _SHOW_5), _PFONT_FACTORY_PAGE_0);
 ...
 //   RTDFactoryOsdFuncPutStringProp(ROW(_FACTORY_COLORTEMP6_ROW), COL(_FACTORY_FUNCTION_COL), _PFONT_FACTORY_PAGE_0, tFONT_FACTORY_EUROPE, tOSD_FACTORY_PAGE_TABLE[15], _ENGLISH);
    ...
    for(ucRowCount = 0; ucRowCount < 4; ucRowCount++)
    {
        ...
        for(ucRowCount = 6; ucRowCount < 8; ucRowCount++)
    {
        RTDFactoryOsdFuncPutStringProp(ROW(_FACTORY_COLORTEMP1_ROW + ucRowCount), COL(_FACTORY_R_COL), _PFONT_FACTORY_PAGE_0, tFONT_FACTORY_EUROPE, tOSD_FACTORY_RGB_TABLE[0], _ENGLISH);
        RTDFactoryOsdFuncPutStringProp(ROW(_FACTORY_COLORTEMP1_ROW + ucRowCount), COL(_FACTORY_G_COL), _PFONT_FACTORY_PAGE_0, tFONT_FACTORY_EUROPE, tOSD_FACTORY_RGB_TABLE[1], _ENGLISH);
        RTDFactoryOsdFuncPutStringProp(ROW(_FACTORY_COLORTEMP1_ROW + ucRowCount), COL(_FACTORY_B_COL), _PFONT_FACTORY_PAGE_0, tFONT_FACTORY_EUROPE, tOSD_FACTORY_RGB_TABLE[2], _ENGLISH);
    ...
    for(ucRowCount = 0; ucRowCount < _CT_COLORTEMP_AMOUNT+1; ucRowCount++)
    {
    ...
    // Burnin on or off
    RTDFactoryOsdFuncPutStringProp(ROW(_FACTORY_BURNIN_ROW), COL(_FACTORY_ON_OFF_COL), _PFONT_FACTORY_BURNIN, tFONT_FACTORY_EUROPE, tOSD_FACTORY_ON_OFF_TABLE[GET_OSD_BURN_STATUS()], _ENGLISH);
    ...
    RTDFactoryOsdFuncDrawWindow(tOSD_FACTORY_WIN0, 0, 0, _FACTORY_OSD_WINDOW_SIZE_X, _FACTORY_OSD_WINDOW_SIZE_Y, _CP_BLACK_1);
...
void RTDFactoryMainMenu1(void)
{
    ...
    RTDFactoryOsdFuncPutStringProp(ROW(_FACTORY_OSD_PAGE_1_ROW), COL(_FACTORY_FUNCTION_COL), _PFONT_FACTORY_PAGE_0, tFONT_FACTORY_EUROPE, tOSD_FACTORY_PAGE_1_TABLE[10], _ENGLISH);
    RTDFactoryOsdFuncPutStringProp(ROW(_FACTORY_EXIT_1_ROW), COL(_FACTORY_FUNCTION_COL), _PFONT_FACTORY_PAGE_0, tFONT_FACTORY_EUROPE, tOSD_FACTORY_PAGE_1_TABLE[11], _ENGLISH);
...
void RTDFactoryBurninOnOffEnter(void)
{
		SET_OSD_BURN_STATUS(g_usAdjustValue);
...
void RTDFactoryDPAuxModeEnter(void)
{
    g_usBackupValue = g_usAdjustValue = UserCommonNVRamGetSystemData(_DP_AUX_DIFF_MODE);
