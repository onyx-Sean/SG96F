...
void SysSourceDetectPort(void)
{
    ...
    switch(GET_PORT_TYPE(GET_INPUTPORT_TYPE(g_ucSearchIndex)))
    {
        ...
        case _PORT_VGA:
            ...
            {
                SET_SOURCE_PREDETECT(g_ucSearchIndex, ScalerSyncProcPreDetect(GET_INPUT_PORT(GET_INPUTPORT_TYPE(g_ucSearchIndex))));
            }
            else if(GET_POWER_STATUS() == _POWER_STATUS_NORMAL)
            {
                ...
                {
                    SET_SOURCE_TYPE(g_ucSearchIndex, SysVgaScanInputPort(GET_INPUT_PORT(GET_INPUTPORT_TYPE(g_ucSearchIndex))));
                }
            }
        ...
        case _PORT_HDMI:
            ...
            if(GET_POWER_STATUS() == _POWER_STATUS_SAVING)
            {
                SET_SOURCE_PREDETECT(g_ucSearchIndex, ScalerTMDSPSPreDetect(GET_INPUT_PORT(GET_INPUTPORT_TYPE(g_ucSearchIndex))));
            }
            else if(GET_POWER_STATUS() == _POWER_STATUS_NORMAL)
            {
                SET_SOURCE_PREDETECT(g_ucSearchIndex, ScalerTMDSNormalPreDetect(GET_INPUT_PORT(GET_INPUTPORT_TYPE(g_ucSearchIndex))));

                if((GET_SOURCE_SEARCH_DELAY_MODE() != _SOURCE_SEARCH_POLLING_MODE) && (GET_SOURCE_PREDETECT(g_ucSearchIndex) == _TRUE))
                {
                    SET_SOURCE_TYPE(g_ucSearchIndex, ScalerTMDSScanInputPort(GET_INPUT_PORT(GET_INPUTPORT_TYPE(g_ucSearchIndex)), GET_INPUTPORT_TYPE(g_ucSearchIndex)));
                }
            }
        ...
        case _PORT_MHL:
            ...
            if((((GET_INPUT_PORT(GET_INPUTPORT_TYPE(g_ucSearchIndex))) == _D0_INPUT_PORT) && (GET_D0_TMDS_MODE() == _TMDS_HDMI_MODE)) ||
               (((GET_INPUT_PORT(GET_INPUTPORT_TYPE(g_ucSearchIndex))) == _D1_INPUT_PORT) && (GET_D1_TMDS_MODE() == _TMDS_HDMI_MODE)) ||
               (((GET_INPUT_PORT(GET_INPUTPORT_TYPE(g_ucSearchIndex))) == _D2_INPUT_PORT) && (GET_D2_TMDS_MODE() == _TMDS_HDMI_MODE)) ||
               (((GET_INPUT_PORT(GET_INPUTPORT_TYPE(g_ucSearchIndex))) == _D3_INPUT_PORT) && (GET_D3_TMDS_MODE() == _TMDS_HDMI_MODE)) ||
               (((GET_INPUT_PORT(GET_INPUTPORT_TYPE(g_ucSearchIndex))) == _D4_INPUT_PORT) && (GET_D4_TMDS_MODE() == _TMDS_HDMI_MODE)) ||
               (((GET_INPUT_PORT(GET_INPUTPORT_TYPE(g_ucSearchIndex))) == _D5_INPUT_PORT) && (GET_D5_TMDS_MODE() == _TMDS_HDMI_MODE)))
            {
                if(GET_POWER_STATUS() == _POWER_STATUS_SAVING)
                {
                    SET_SOURCE_PREDETECT(g_ucSearchIndex, ScalerTMDSPSPreDetect(GET_INPUT_PORT(GET_INPUTPORT_TYPE(g_ucSearchIndex))));
            ...
            else if((((GET_INPUT_PORT(GET_INPUTPORT_TYPE(g_ucSearchIndex))) == _D0_INPUT_PORT) && (GET_D0_TMDS_MODE() == _TMDS_MHL_MODE)) ||
                    (((GET_INPUT_PORT(GET_INPUTPORT_TYPE(g_ucSearchIndex))) == _D1_INPUT_PORT) && (GET_D1_TMDS_MODE() == _TMDS_MHL_MODE)) ||
                    (((GET_INPUT_PORT(GET_INPUTPORT_TYPE(g_ucSearchIndex))) == _D2_INPUT_PORT) && (GET_D2_TMDS_MODE() == _TMDS_MHL_MODE)) ||
                    (((GET_INPUT_PORT(GET_INPUTPORT_TYPE(g_ucSearchIndex))) == _D3_INPUT_PORT) && (GET_D3_TMDS_MODE() == _TMDS_MHL_MODE)) ||
                    (((GET_INPUT_PORT(GET_INPUTPORT_TYPE(g_ucSearchIndex))) == _D4_INPUT_PORT) && (GET_D4_TMDS_MODE() == _TMDS_MHL_MODE)) ||
                    (((GET_INPUT_PORT(GET_INPUTPORT_TYPE(g_ucSearchIndex))) == _D5_INPUT_PORT) && (GET_D5_TMDS_MODE() == _TMDS_MHL_MODE)))
            {
                if(GET_POWER_STATUS() == _POWER_STATUS_SAVING)
                {
                    SET_SOURCE_PREDETECT(g_ucSearchIndex, ScalerMHLPSPreDetect(GET_INPUT_PORT(GET_INPUTPORT_TYPE(g_ucSearchIndex))));
                }
                else if(GET_POWER_STATUS() == _POWER_STATUS_NORMAL)
                {
                    SET_SOURCE_PREDETECT(g_ucSearchIndex, ScalerMHLNormalPreDetect(GET_INPUT_PORT(GET_INPUTPORT_TYPE(g_ucSearchIndex))));
        ...
        case _PORT_DUAL_DVI:
            ...
            if(GET_POWER_STATUS() == _POWER_STATUS_SAVING)
            {
                SET_SOURCE_PREDETECT(g_ucSearchIndex, ScalerDualLinkDVIPSPreDetect(GET_INPUT_PORT(GET_INPUTPORT_TYPE(g_ucSearchIndex))));
            }
            else if(GET_POWER_STATUS() == _POWER_STATUS_NORMAL)
            {
                SET_SOURCE_PREDETECT(g_ucSearchIndex, ScalerDualLinkDVINormalPreDetect(GET_INPUT_PORT(GET_INPUTPORT_TYPE(g_ucSearchIndex))));

                if((GET_SOURCE_SEARCH_DELAY_MODE() != _SOURCE_SEARCH_POLLING_MODE) && (GET_SOURCE_PREDETECT(g_ucSearchIndex) == _TRUE))
                {
                    SET_SOURCE_TYPE(g_ucSearchIndex, ScalerDualLinkDVIScanInputPort(GET_INPUT_PORT(GET_INPUTPORT_TYPE(g_ucSearchIndex))));
                }
            }
        ...
        case _PORT_DP:
            ...
            if(GET_POWER_STATUS() == _POWER_STATUS_SAVING)
            {
                SET_SOURCE_PREDETECT(g_ucSearchIndex, ScalerDpPSPreDetect((GET_INPUT_PORT(GET_INPUTPORT_TYPE(g_ucSearchIndex)))));
            }
            else if(GET_POWER_STATUS() == _POWER_STATUS_NORMAL)
            {
                SET_SOURCE_PREDETECT(g_ucSearchIndex, ScalerDpNormalPreDetect((GET_INPUT_PORT(GET_INPUTPORT_TYPE(g_ucSearchIndex)))));

                if((GET_SOURCE_SEARCH_DELAY_MODE() != _SOURCE_SEARCH_POLLING_MODE) && (GET_SOURCE_PREDETECT(g_ucSearchIndex) == _TRUE))
                {
                    SET_SOURCE_TYPE(g_ucSearchIndex, ScalerDpScanInputPort((GET_INPUT_PORT(GET_INPUTPORT_TYPE(g_ucSearchIndex)))));
                }
            }
...
void SysSourceScanPortInitial(void)
{
    ScalerSyncInterfaceSwitch(GET_INPUT_PORT(GET_INPUTPORT_TYPE(g_ucSearchIndex)), GET_PORT_TYPE(GET_INPUTPORT_TYPE(g_ucSearchIndex)), GET_SOURCE_SEARCH_DELAY_MODE());
    ...
    switch(GET_PORT_TYPE(GET_INPUTPORT_TYPE(g_ucSearchIndex)))
    {
        ...
        case _PORT_MHL:
            ...
            DebugMessageSystem("7. TMDS Port Initial", GET_PORT_TYPE(GET_INPUTPORT_TYPE(g_ucSearchIndex)));

            if(GET_POWER_STATUS() == _POWER_STATUS_NORMAL)
            {
                ScalerSyncTMDSScanInitial(SysSourceGetInputPort());
            }
        ...
        case _PORT_DUAL_DVI:
            ...
            if(GET_POWER_STATUS() == _POWER_STATUS_NORMAL)
            {
                ScalerDualLinkDVIScanInitial(SysSourceGetInputPort());
            }
        ...
        case _PORT_DP:
            ...
            if(GET_POWER_STATUS() == _POWER_STATUS_NORMAL)
            {
                ScalerDpScanInitial((GET_INPUT_PORT(GET_INPUTPORT_TYPE(g_ucSearchIndex))));
            }
...
void SysSourceInfoReset(void)
{
    ...
    ScalerTimerActiveTimerEvent(SEC(0.0), _SYSTEM_TIMER_EVENT_D0_TYPEC_CABLE_DETECT);
#endif

#if((_D1_INPUT_PORT_TYPE != _D1_NO_PORT) && (_D1_DP_TYPE_C_SUPPORT == _ON))
    ScalerTimerActiveTimerEvent(SEC(0.0), _SYSTEM_TIMER_EVENT_D1_TYPEC_CABLE_DETECT);
#endif

#if((_D2_INPUT_PORT_TYPE != _D2_NO_PORT) && (_D2_DP_TYPE_C_SUPPORT == _ON))
    ScalerTimerActiveTimerEvent(SEC(0.0), _SYSTEM_TIMER_EVENT_D2_TYPEC_CABLE_DETECT);
#endif

#if((_D6_INPUT_PORT_TYPE != _D6_NO_PORT) && (_D6_DP_TYPE_C_SUPPORT == _ON))
    ScalerTimerActiveTimerEvent(SEC(0.0), _SYSTEM_TIMER_EVENT_D6_TYPEC_CABLE_DETECT);
#endif
}
...
void SysSourceCableDetection(void)
{
    ...
    SET_D0_CABLE_STATUS(SysDpTypeCGetD0CableConnectCheck());
#else
    ...
    SET_D1_CABLE_STATUS(SysDpTypeCGetD1CableConnectCheck());
#else
    ...
    SET_D2_CABLE_STATUS(SysDpTypeCGetD2CableConnectCheck());
#else
    ...
    SET_D6_CABLE_STATUS(!SysDpTypeCGetD6CableConnectCheck());
#else
...
#if((_DP_TYPE_C_SUPPORT == _ON) && (_D0_DP_TYPE_C_SUPPORT == _ON))
                            SET_D0_DP_TYPE_C_LANE_STATUS(0);
                            UserCommonPortControllerSetCfgDetectFlag(_D0_INPUT_PORT, _ENABLE);
                            DebugMessageSystem("8. Type-C Cable Plug In", GET_D0_DP_TYPE_C_ALTMODE_STATUS());
#endif
                        }
                        else
                        {
...
#endif
                            {
                                ...
                                ScalerDpHotPlugEvent(_D0_INPUT_PORT, _DP_HPD_LOW);

#if((_DP_TYPE_C_SUPPORT == _ON) && (_D0_DP_TYPE_C_SUPPORT == _ON))
                                UserCommonPortControllerSetCfgDetectFlag(_D0_INPUT_PORT, _DISABLE);
                                UserCommonPortControllerSetAltModeFlag(_D0_INPUT_PORT, _FALSE);
#endif

#if(_HDCP_2_2_SUPPORT == _ON)
                                // HDCP2 Reset Proc
                                ScalerHdcp2ResetProc(_D0_INPUT_PORT);
#endif
                            }
                        }
...
#if((_DP_TYPE_C_SUPPORT == _ON) && (_D1_DP_TYPE_C_SUPPORT == _ON))
                            SET_D1_DP_TYPE_C_LANE_STATUS(0);
                            UserCommonPortControllerSetCfgDetectFlag(_D1_INPUT_PORT, _ENABLE);
                            DebugMessageSystem("8. Type-C Cable Plug In", GET_D1_DP_TYPE_C_ALTMODE_STATUS());
#endif
                        }
                        else
                        {
                            ...
                            ScalerDpHotPlugEvent(_D1_INPUT_PORT, _DP_HPD_LOW);

#if((_DP_TYPE_C_SUPPORT == _ON) && (_D1_DP_TYPE_C_SUPPORT == _ON))
                            UserCommonPortControllerSetCfgDetectFlag(_D1_INPUT_PORT, _DISABLE);
                            UserCommonPortControllerSetAltModeFlag(_D1_INPUT_PORT, _FALSE);
#endif

#if(_HDCP_2_2_SUPPORT == _ON)
                            // HDCP2 Reset Proc
                            ScalerHdcp2ResetProc(_D1_INPUT_PORT);
#endif
                        }
...
#if((_DP_TYPE_C_SUPPORT == _ON) && (_D2_DP_TYPE_C_SUPPORT == _ON))
                            SET_D2_DP_TYPE_C_LANE_STATUS(0);
                            UserCommonPortControllerSetCfgDetectFlag(_D2_INPUT_PORT, _ENABLE);
                            DebugMessageSystem("8. Type-C Cable Plug In", GET_D2_DP_TYPE_C_ALTMODE_STATUS());
#endif
                        }
                        else
                        {
                            ...
                            ScalerDpDpcdLinkStatusReset(_D2_INPUT_PORT);
                            ScalerDpHotPlugEvent(_D2_INPUT_PORT, _DP_HPD_LOW);

#if((_DP_TYPE_C_SUPPORT == _ON) && (_D2_DP_TYPE_C_SUPPORT == _ON))
                            UserCommonPortControllerSetCfgDetectFlag(_D2_INPUT_PORT, _DISABLE);
                            UserCommonPortControllerSetAltModeFlag(_D2_INPUT_PORT, _FALSE);
#endif
                        }
...
#if(_HDCP_2_2_SUPPORT == _ON)
                            ScalerHdcp2ResetProc(_D2_INPUT_PORT);
#endif
                        }
...
#if(_HDCP_2_2_SUPPORT == _ON)
                            ScalerHdcp2ResetProc(_D3_INPUT_PORT);
#endif
                        }
...
#if(_HDCP_2_2_SUPPORT == _ON)
                            ScalerHdcp2ResetProc(_D4_INPUT_PORT);
#endif
                        }
...
#if(_HDCP_2_2_SUPPORT == _ON)
                            ScalerHdcp2ResetProc(_D5_INPUT_PORT);
#endif
                        }
...
#if((_DP_TYPE_C_SUPPORT == _ON) && (_D6_DP_TYPE_C_SUPPORT == _ON))
                            SET_D6_DP_TYPE_C_LANE_STATUS(0);
                            UserCommonPortControllerSetCfgDetectFlag(_D6_INPUT_PORT, _ENABLE);
                            DebugMessageSystem("8. Type-C Cable Plug In", GET_D6_DP_TYPE_C_ALTMODE_STATUS());
#endif
                        }
                        else
                        {
...
#if((_DP_TYPE_C_SUPPORT == _ON) && (_D6_DP_TYPE_C_SUPPORT == _ON))
                                UserCommonPortControllerSetCfgDetectFlag(_D6_INPUT_PORT, _DISABLE);
                                UserCommonPortControllerSetAltModeFlag(_D6_INPUT_PORT, _FALSE);
#endif
                            }
                        }
...
void SysSourceHdmi5VDetection(void)
{
    ...
    if(GET_HDMI_HOTPLUG_TOGGLE() == _TRUE)
    {
        ...
        {
            if(SET_D2_HDMI_5V_STATUS() == _FALSE)
            {
...
void SysSourceEmbeddedDpSwitch(EnumSourceSearchPort enumDpPort)
{
    switch(enumDpPort)
    {
        ...
        default:
            // Do nothing on non-DP ports
            return;
    }

    ScalerDpEmbeddedSwitchSetting(enumDpPort);
    ...
    SET_DP_EMBEDDED_SWITCH_SELECT(enumDpPort);
