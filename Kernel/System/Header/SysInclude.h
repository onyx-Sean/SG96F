...
#define SET_D2_DP_TYPE_C_LANE_STATUS(x)         (g_stD2PortControllerInfo.b4Lanes = (x))
#define GET_D2_DP_TYPE_C_LANE_STATUS()          (g_stD2PortControllerInfo.b4Lanes)

#define GET_D2_DP_TYPE_C_CABLE_DETECT()         ((bit)g_stD2PortControllerInfo.b1CableDetectFlag)
#define SET_D2_DP_TYPE_C_CABLE_DETECT()         (g_stD2PortControllerInfo.b1CableDetectFlag = _TRUE)
#define CLR_D2_DP_TYPE_C_CABLE_DETECT()         (g_stD2PortControllerInfo.b1CableDetectFlag = _FALSE)

#define GET_D2_DP_TYPE_C_ALTMODE_STATUS()       ((bit)g_stD2PortControllerInfo.b1AltModeStatusLastCheck)
#define SET_D2_DP_TYPE_C_ALTMODE_STATUS()       (g_stD2PortControllerInfo.b1AltModeStatusLastCheck = _TRUE)
#define CLR_D2_DP_TYPE_C_ALTMODE_STATUS()       (g_stD2PortControllerInfo.b1AltModeStatusLastCheck = _FALSE)
...
#define GET_D2_USB_HUB_PLUG_DEVICE_CHANGE_FLG() (g_stD2UsbHubInfo.b1UsbHubDeviceChangeFlg)
#define SET_D2_USB_HUB_PLUG_DEVICE_CHANGE_FLG() (g_stD2UsbHubInfo.b1UsbHubDeviceChangeFlg = _TRUE)
#define CLR_D2_USB_HUB_PLUG_DEVICE_CHANGE_FLG() (g_stD2UsbHubInfo.b1UsbHubDeviceChangeFlg = _FALSE)
#endif
...
#if(_D2_DP_TYPE_C_SUPPORT == _ON)
extern StructPortController g_stD2PortControllerInfo;
