...
#if((_D0_DP_TYPE_C_USB_HUB_TYPE == _RTS5411_SERIES) || (_D1_DP_TYPE_C_USB_HUB_TYPE == _RTS5411_SERIES) || (_D2_DP_TYPE_C_USB_HUB_TYPE == _RTS5411_SERIES) || (_D6_DP_TYPE_C_USB_HUB_TYPE == _RTS5411_SERIES))
...
bit UserCommonUsbHubSetSSMode(BYTE ucInputPort, bit bEn)
{
    ...
    if(UserInterfaceTypeCUsbHubU3InfoDectectUserFlow(ucInputPort) == _TRUE)
    {
...
BYTE UserCommonUsbHubDetectSSDevicePlugInfo(BYTE ucInputPort)
{
    ...
    if(UserInterfaceTypeCUsbHubU3InfoDectectUserFlow(ucInputPort) == _TRUE)
    {
        ucUsbHubInfo = UserInterfaceTypecUsbHubDetectSSDevicePlugInfo(ucInputPort);
    }
    else
    {
        // Execute Write Command
...
#endif // End of #if((_D0_DP_TYPE_C_USB_HUB_TYPE == _RTS5411_SERIES) || (_D1_DP_TYPE_C_USB_HUB_TYPE == _RTS5411_SERIES) || (_D2_DP_TYPE_C_USB_HUB_TYPE == _RTS5411_SERIES) || (_D6_DP_TYPE_C_USB_HUB_TYPE == _RTS5411_SERIES))
