...
bit UserCommonTypecCommunicationWrite(BYTE ucSlaveAddr, WORD usSubAddr, BYTE ucSubAddrLength, WORD usLength, BYTE *pucWriteArray, BYTE ucInputPort)
{
    ...
    {
#if(_D0_DP_TYPE_C_SMBUS_IIC == _SW_IIC_PIN_GPIO)

        if(UserCommonTypecCommunicationSMBWrite(ucSlaveAddr, usSubAddr, ucSubAddrLength, usLength, pucWriteArray, _IIC_SMBUS, _D0_DP_TYPE_C_SMBUS_IIC) == _FAIL)
        {
            return _FAIL;
        }

#elif(_D0_DP_TYPE_C_SMBUS_IIC != _NO_IIC_PIN)

        if(UserCommonTypecCommunicationSMBWrite(ucSlaveAddr, usSubAddr, ucSubAddrLength, usLength, pucWriteArray, 0x00, _D0_DP_TYPE_C_SMBUS_IIC) == _FAIL)
        {
            return _FAIL;
        }
#endif
    ...
    {
#if(_D1_DP_TYPE_C_SMBUS_IIC == _SW_IIC_PIN_GPIO)

        if(UserCommonTypecCommunicationSMBWrite(ucSlaveAddr, usSubAddr, ucSubAddrLength, usLength, pucWriteArray, _IIC_SMBUS, _D1_DP_TYPE_C_SMBUS_IIC) == _FAIL)
        {
            return _FAIL;
        }

#elif(_D1_DP_TYPE_C_SMBUS_IIC != _NO_IIC_PIN)

        if(UserCommonTypecCommunicationSMBWrite(ucSlaveAddr, usSubAddr, ucSubAddrLength, usLength, pucWriteArray, 0x00, _D1_DP_TYPE_C_SMBUS_IIC) == _FAIL)
        {
            return _FAIL;
        }
#endif
    ...
    {
#if(_D2_DP_TYPE_C_SMBUS_IIC == _SW_IIC_PIN_GPIO)

        if(UserCommonTypecCommunicationSMBWrite(ucSlaveAddr, usSubAddr, ucSubAddrLength, usLength, pucWriteArray, _IIC_SMBUS, _D2_DP_TYPE_C_SMBUS_IIC) == _FAIL)
        {
            return _FAIL;
        }

#elif(_D2_DP_TYPE_C_SMBUS_IIC != _NO_IIC_PIN)

        if(UserCommonTypecCommunicationSMBWrite(ucSlaveAddr, usSubAddr, ucSubAddrLength, usLength, pucWriteArray, 0x00, _D2_DP_TYPE_C_SMBUS_IIC) == _FAIL)
        {
            return _FAIL;
        }
#endif
    ...
    else if(ucInputPort == _D6_INPUT_PORT)
    {
        ...
        if(UserCommonTypecCommunicationSMBWrite(ucSlaveAddr, usSubAddr, ucSubAddrLength, usLength, pucWriteArray, _IIC_SMBUS, _D6_DP_TYPE_C_SMBUS_IIC) == _FAIL)
        {
            return _FAIL;
        }

#elif(_D6_DP_TYPE_C_SMBUS_IIC != _NO_IIC_PIN)

        if(UserCommonTypecCommunicationSMBWrite(ucSlaveAddr, usSubAddr, ucSubAddrLength, usLength, pucWriteArray, 0x00, _D6_DP_TYPE_C_SMBUS_IIC) == _FAIL)
        {
            return _FAIL;
        }
#endif
...
bit UserCommonTypecCommunicationRead(BYTE ucSlaveAddr, WORD usSubAddr, BYTE ucSubAddrLength, WORD usLength, BYTE *pucReadArray, BYTE ucInputPort)
{
    if(ucInputPort == _D0_INPUT_PORT)
    {
        ...
        if(UserCommonTypecCommunicationSMBRead(ucSlaveAddr, usSubAddr, ucSubAddrLength, usLength, pucReadArray, _IIC_SMBUS, _D0_DP_TYPE_C_SMBUS_IIC) == _FAIL)
        {
            return _FAIL;
        }
        ...
        if(UserCommonTypecCommunicationSMBRead(ucSlaveAddr, usSubAddr, ucSubAddrLength, usLength, pucReadArray, 0x00, _D0_DP_TYPE_C_SMBUS_IIC) == _FAIL)
        {
            return _FAIL;
        }
#endif
    ...
    else if(ucInputPort == _D1_INPUT_PORT)
    {
        ...
        if(UserCommonTypecCommunicationSMBRead(ucSlaveAddr, usSubAddr, ucSubAddrLength, usLength, pucReadArray, _IIC_SMBUS, _D1_DP_TYPE_C_SMBUS_IIC) == _FAIL)
        {
            return _FAIL;
        }
        ...
        if(UserCommonTypecCommunicationSMBRead(ucSlaveAddr, usSubAddr, ucSubAddrLength, usLength, pucReadArray, 0x00, _D1_DP_TYPE_C_SMBUS_IIC) == _FAIL)
        {
            return _FAIL;
        }
#endif
    ...
    else if(ucInputPort == _D2_INPUT_PORT)
    {
        ...
        if(UserCommonTypecCommunicationSMBRead(ucSlaveAddr, usSubAddr, ucSubAddrLength, usLength, pucReadArray, _IIC_SMBUS, _D2_DP_TYPE_C_SMBUS_IIC) == _FAIL)
        {
            return _FAIL;
        }
        ...
        if(UserCommonTypecCommunicationSMBRead(ucSlaveAddr, usSubAddr, ucSubAddrLength, usLength, pucReadArray, 0x00, _D2_DP_TYPE_C_SMBUS_IIC) == _FAIL)
        {
            return _FAIL;
        }
#endif
    ...
    {
#if(_D6_DP_TYPE_C_SMBUS_IIC == _SW_IIC_PIN_GPIO)

        if(UserCommonTypecCommunicationSMBRead(ucSlaveAddr, usSubAddr, ucSubAddrLength, usLength, pucReadArray, _IIC_SMBUS, _D6_DP_TYPE_C_SMBUS_IIC) == _FAIL)
        {
            return _FAIL;
        }
        ...
        if(UserCommonTypecCommunicationSMBRead(ucSlaveAddr, usSubAddr, ucSubAddrLength, usLength, pucReadArray, 0x00, _D6_DP_TYPE_C_SMBUS_IIC) == _FAIL)
        {
            return _FAIL;
        }
#endif
...
bit UserCommonTypecCommunicationShortRead(BYTE ucDeviceAddr, BYTE *pucReadArray, BYTE ucInputPort)
{
    if(ucInputPort == _D0_INPUT_PORT)
    {
        ...
        if(UserCommonTypecCommunicationSMBRead(ucDeviceAddr, 0x00, 0, 1, pucReadArray, _IIC_SMBUS, _D0_DP_TYPE_C_SMBUS_IIC) == _FAIL)
        {
            return _FAIL;
        }
        ...
        if(UserCommonTypecCommunicationSMBRead(ucDeviceAddr, 0x00, 0, 1, pucReadArray, 0x00, _D0_DP_TYPE_C_SMBUS_IIC) == _FAIL)
        {
            return _FAIL;
        }
#endif
    ...
    else if(ucInputPort == _D1_INPUT_PORT)
    {
        ...
        if(UserCommonTypecCommunicationSMBRead(ucDeviceAddr, 0x00, 0, 1, pucReadArray, _IIC_SMBUS, _D1_DP_TYPE_C_SMBUS_IIC) == _FAIL)
        {
            return _FAIL;
        }
        ...
        if(UserCommonTypecCommunicationSMBRead(ucDeviceAddr, 0x00, 0, 1, pucReadArray, 0x00, _D1_DP_TYPE_C_SMBUS_IIC) == _FAIL)
        {
            return _FAIL;
        }
#endif
    ...
    else if(ucInputPort == _D2_INPUT_PORT)
    {
        ...
        if(UserCommonTypecCommunicationSMBRead(ucDeviceAddr, 0x00, 0, 1, pucReadArray, _IIC_SMBUS, _D2_DP_TYPE_C_SMBUS_IIC) == _FAIL)
        {
            return _FAIL;
        }
        ...
        if(UserCommonTypecCommunicationSMBRead(ucDeviceAddr, 0x00, 0, 1, pucReadArray, 0x00, _D2_DP_TYPE_C_SMBUS_IIC) == _FAIL)
        {
            return _FAIL;
        }
#endif
    ...
    else if(ucInputPort == _D6_INPUT_PORT)
    {
        ...
        if(UserCommonTypecCommunicationSMBRead(ucDeviceAddr, 0x00, 0, 1, pucReadArray, _IIC_SMBUS, _D6_DP_TYPE_C_SMBUS_IIC) == _FAIL)
        {
            return _FAIL;
        }
        ...
        if(UserCommonTypecCommunicationSMBRead(ucDeviceAddr, 0x00, 0, 1, pucReadArray, 0x00, _D6_DP_TYPE_C_SMBUS_IIC) == _FAIL)
        {
            return _FAIL;
        }
#endif
