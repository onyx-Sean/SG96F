...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6193_Series_TMDSRx1Include.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
...
#define GET_HDMI_RX1_HDR_INFO_FRAME_RECEIVED()          (g_stTMDSRx1CtrlInfo.b1HDRInfoFrameReceived)
#define SET_HDMI_RX1_HDR_INFO_FRAME_RECEIVED()          (g_stTMDSRx1CtrlInfo.b1HDRInfoFrameReceived = _TRUE)
#define CLR_HDMI_RX1_HDR_INFO_FRAME_RECEIVED()          (g_stTMDSRx1CtrlInfo.b1HDRInfoFrameReceived = _FALSE)
#endif
...
#endif
#if(_ULTRA_HDR_SUPPORT == _ON)
extern void ScalerTMDSRx1GetHDRData(BYTE *pucHDRData);
#endif
