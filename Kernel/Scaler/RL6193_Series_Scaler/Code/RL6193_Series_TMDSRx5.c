...
#define __RL6193_SERIES_TMDSRX5__
...
void ScalerTMDSRx5SetPhy_EXINT0(void) using 1
{
    ...
    if(ScalerGetBit_EXINT(PB4_A0_CMU_00, _BIT6) == _BIT6)   // MHL Mode
    {
        ...
        else  // MHL 24bit Mode
        {
            ...
            if((GET_INPUT_PIXEL_CLK() >= 700) && (GET_INPUT_PIXEL_CLK() < 1125))
            {
                ...
                ScalerSetBit_EXINT(PB4_A6_CMU_06, ~_BIT6, _BIT6);
            }
            ...
            else if(GET_INPUT_PIXEL_CLK() < 3000)
            {
                ...
                ScalerSetBit_EXINT(PB4_FD_LANE0_A_CDR_07, ~(_BIT4 | _BIT3 | _BIT2), (_BIT3 | _BIT2));
...
#endif
    {
        ...
        else if((GET_INPUT_PIXEL_CLK() >= 375) && (GET_INPUT_PIXEL_CLK() < 750))
        {
            ...
            // [4:2] CMU_PI_I_SEL = 3'b100 --> 15.625uA
            // [1:0] CMU_SELPREDIV = 2'b00 --> /1
            ScalerSetByte_EXINT(PB4_A3_CMU_03, 0x70);
        ...
        else if((GET_INPUT_PIXEL_CLK() >= 750) && (GET_INPUT_PIXEL_CLK() < 1500))
        {
            ...
            ScalerSetByte_EXINT(PB4_F2_SDM_01, 0x10);
        }
    ...
    // [2] cmu_sel_D5 = 1'b0 --> CMU Feedback Loop Divider = 1
...
#endif
    {
        ...
        {
            // KP = 0x20 --> KP = 8
            ScalerSetByte_EXINT(PB4_D6_KP_0, 0x20);
            ScalerSetByte_EXINT(PB4_D7_KP_1, 0x20);
            ScalerSetByte_EXINT(PB4_D8_KP_2, 0x20);
        }
    ...
    if((ScalerGetBit_EXINT(PB4_A0_CMU_00, _BIT6) == _BIT6) &&
       (((GET_TMDS_RX5_CLK_MODE() == _TMDS_MHL_PPMODE_PHY_SETTING)) ||
        ((GET_TMDS_RX5_CLK_MODE() == _TMDS_24BIT_PHY_SETTING) && (GET_INPUT_PIXEL_CLK() >= 2000))))
    {
        // [7] Enable Lane0 ACDR
...
bit ScalerTMDSRx5CheckDataDFE(void)
{
    ...
    if(ScalerGetBit(PB4_A0_CMU_00, _BIT6) != _BIT6)   // HDMI MODE
    {
...
void ScalerTMDSRx5HotPlugEvent(void)
{
...
#endif
    {
        ...
        ScalerGetDataPortByte(P74_C3_HDCP_AP, _P74_C4_PT_C2_PORT_PAGE74_HDCP_SLAVE_ADD, 1, &ucSlaveAddr, _NON_AUTOINC);
...
#endif
        {
            ...
            ScalerSetDataPortByte(P74_C3_HDCP_AP, _P74_C4_PT_C2_PORT_PAGE74_HDCP_SLAVE_ADD, ucSlaveAddr);
        }
