...
#define __RL6193_SERIES_DPRX1__
...
void ScalerDpRx1DpcdInitial(EnumDpVersionType enumDpVersion, EnumDpLaneCount enumDpLaneCount, EnumDPMSTPort enumDpRxMstPort);
...
void ScalerDpRx1DpcdInitial(EnumDpVersionType enumDpVersion, EnumDpLaneCount enumDpLaneCount, EnumDPMSTPort enumDpRxMstPort)
{
    ...
    ScalerDpRx1SetDpcdValue(0x00, 0x00, 0x04, 0x21);
#else
    ScalerDpRx1SetDpcdValue(0x00, 0x00, 0x04, 0x20);
#endif
...
void ScalerDpRx1ChangeDpcdVersion(EnumDpVersionType enumDpVersion, EnumDPMSTPort enumDpRxMstPort)
{
    ...
    if(enumDpVersion == _DP_VERSION_1_2)
    {
        ...
        ScalerDpRx1SetDpcdValue(0x00, 0x00, 0x00, 0x12);
...
void ScalerDpRx1MacInitial(void)
{
    ...
    ScalerSetByte(PB0_03_LANE_MUX, 0xE4);
...
bit ScalerDpRx1InterlaceCheck(WORD *pusVTotal, BYTE *pucOddFlg)
{
...
#endif
    {
        ...
        if(ScalerGetBit(PB9_01_DP_VBID, _BIT2) == _BIT2) // Interlace
        {
            ...
            // Enable DP Interlace
            ScalerSetBit(PB8_57_INTERLACE_MODE_CONFIG, ~_BIT7, _BIT7);

            if((*pucOddFlg) == _FALSE)
            {
                // Disable DP Interlace
                ScalerSetBit(PB8_57_INTERLACE_MODE_CONFIG, ~_BIT7, 0x00);
            }
            ...
            if(((pData[1] & _BIT1) != (pData[2] & _BIT1)) && (usVstart > (usVsyncWidth + _DP_VSYNC_WIDTH + 2)))
            {
                ...
                ScalerSetBit(PB8_57_INTERLACE_MODE_CONFIG, ~_BIT6, 0x00);
            ...
            {
                // Field reference HW
                ScalerSetBit(PB8_57_INTERLACE_MODE_CONFIG, ~_BIT6, _BIT6);
            }
...
bit ScalerDpRx1HdcpCheck(void)
{
    ...
    if((ScalerDpRx1GetDpcdInfo(0x00, 0x01, 0x11) & _BIT2) == 0x00)
    {
        return _FALSE;
    }

    if(ScalerDpRx1HdcpMeasureCheck() == _TRUE)
    {
        return _TRUE;
    }
...
bit ScalerDpRx1MstToSstStreamClkRegenerate(void)
{
    ...
    */
    ...
    // Disable HSync Tracking
    ScalerSetBit(P4A_A7_MN_SCLKG_TRK_CTRL, ~_BIT6, 0x00);
...
bit ScalerDpRx1MstToSstInterlaceCheck(WORD *pusVTotal, BYTE *pucOddFlg)
{
...
#endif
    {
        ...
        if(ScalerGetBit(P4A_29_MST2SST_VBID, _BIT2) == _BIT2) // Interlace
        {
            ...
            // Enable DP Interlace
            ScalerSetBit(P4A_56_INTERLACE_MODE_CONFIG, ~_BIT7, _BIT7);

            if((*pucOddFlg) == _FALSE)
            {
                // Disable DP Interlace
                ScalerSetBit(P4A_56_INTERLACE_MODE_CONFIG, ~_BIT7, 0x00);
            }
            ...
            {
                // Field Information reference to VBID
                ScalerSetBit(P4A_56_INTERLACE_MODE_CONFIG, ~_BIT6, 0x00);
            ...
            {
                // Field reference HW
                ScalerSetBit(P4A_56_INTERLACE_MODE_CONFIG, ~_BIT6, _BIT6);
            }
