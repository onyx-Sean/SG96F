...
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6193_Series_QC_Color_DDomain_II.c No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------

#define __RL6193_SERIES_QC_COLOR_DDOMAIN_II__
...
{
    0x28, 0xD1, 0xEE, 0x96, 0x28, 0x9D, // M1
    0x96, 0x01, 0x7D, 0x38, 0x0C, 0x38, // M2
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, // Sub
};
...
BYTE code t3DGAMMA_CRC_Table0[] = {
    0x5C, 0x4D, 0x2D, 0x06, 0x53, 0x8F, // M1
    0xE1, 0x85, 0xBA, 0x95, 0xC2, 0x7C, // M2
};

BYTE code t3DGAMMA_CRC_Table1[] = {
    0x97, 0x3E, 0x5C, 0x34, 0xF8, 0x1B, // M1
    0xC2, 0x64, 0x43, 0xDC, 0xFC, 0x3E, // M2
};

BYTE code t3DGAMMA_CRC_Table2[] = {
    0xEC, 0x19, 0xC2, 0x38, 0x48, 0x0F, // M1
    0xAF, 0x36, 0x88, 0xD9, 0x73, 0x13, // M2
};
...
void ScalerQCPrintCRC_D_II(BYTE ucFrame, BYTE ucPath, BYTE *ucCRC, BYTE ucNum);
bit ScalerQCCRCCompare_D_II(BYTE ucPosition, BYTE ucSourceSel, BYTE *ucCRC, BYTE ucFrameNum);
...
bit ScalerQCDCCTest(void)
{
    ...
    ScalerQCWaitForIDDomainEvent(_EVENT_DVS, _INPUT_PATH_ALL);
    usData = (usData | ((WORD)ScalerQCCRCCompare_D_II( _D_CRC_AFTER_DDITHER, _M1 | _M2, tQC_DCC_CRC_TABLE12, 1) << 8));
    ...
    DebugMessageQC("5. Mode_0", 0x00);
    ScalerQCWaitForIDDomainEvent(_EVENT_DVS, _INPUT_PATH_ALL);
    usData = (usData | ((WORD)ScalerQCCRCCompare_D_II( _D_CRC_AFTER_DDITHER, _M1 | _M2, tQC_DCC_CRC_TABLE0, 1) << 0));
    ...
    DebugMessageQC("5. Mode_1", 0x00);
    ScalerQCWaitForIDDomainEvent(_EVENT_DVS, _INPUT_PATH_ALL);
    usData = (usData | ((WORD)ScalerQCCRCCompare_D_II( _D_CRC_AFTER_DDITHER, _M1 | _M2, tQC_DCC_CRC_TABLE1, 1) << 1));
    ...
    DebugMessageQC("5. Mode_2", 0x00);
    ScalerQCWaitForIDDomainEvent(_EVENT_DVS, _INPUT_PATH_ALL);
    usData = (usData | ((WORD)ScalerQCCRCCompare_D_II( _D_CRC_AFTER_DDITHER, _M1 | _M2, tQC_DCC_CRC_TABLE2, 1) << 2));
    ...
    DebugMessageQC("5. Mode_3", 0x00);
    ScalerQCWaitForIDDomainEvent(_EVENT_DVS, _INPUT_PATH_ALL);
    usData = (usData | ((WORD)ScalerQCCRCCompare_D_II( _D_CRC_AFTER_DDITHER, _M1 | _M2, tQC_DCC_CRC_TABLE3, 1) << 3));
    ...
    DebugMessageQC("5. Mode_4", 0x00);
    ScalerQCWaitForIDDomainEvent(_EVENT_DVS, _INPUT_PATH_ALL);
    usData = (usData | ((WORD)ScalerQCCRCCompare_D_II( _D_CRC_AFTER_DDITHER, _M1 | _M2, tQC_DCC_CRC_TABLE4, 1) << 4));
    ...
    ScalerQCWaitForIDDomainEvent(_EVENT_DVS, _INPUT_PATH_ALL);
    usData = (usData | ((WORD)ScalerQCCRCCompare_D_II( _D_CRC_AFTER_DDITHER, _M1 | _M2, tQC_DCC_CRC_TABLE5, 1) << 5));
    ...
    ScalerQCWaitForIDDomainEvent(_EVENT_DVS, _INPUT_PATH_ALL);
    usData = (usData | ((WORD)ScalerQCCRCCompare_D_II( _D_CRC_AFTER_DDITHER, _M1 | _M2, tQC_DCC_CRC_TABLE6, 1) << 6));
    ...
    ScalerQCWaitForIDDomainEvent(_EVENT_DVS, _INPUT_PATH_ALL);
    usData = (usData | ((WORD)ScalerQCCRCCompare_D_II( _D_CRC_AFTER_DDITHER, _M1 | _M2, tQC_DCC_CRC_TABLE7, 1) << 7));
    ...
    ScalerQCWaitForIDDomainEvent(_EVENT_DVS, _INPUT_PATH_ALL);
    usData = (usData | ((WORD)ScalerQCCRCCompare_D_II( _D_CRC_AFTER_DDITHER, _M1 | _M2, tQC_DCC_CRC_TABLE8, 1) << 7));
    ...
    ScalerQCWaitForIDDomainEvent(_EVENT_DVS, _INPUT_PATH_ALL);
    usData = (usData | ((WORD)ScalerQCCRCCompare_D_II( _D_CRC_AFTER_DDITHER, _M1 | _M2, tQC_DCC_CRC_TABLE9, 1) << 7));
    ...
    ScalerQCWaitForIDDomainEvent(_EVENT_DVS, _INPUT_PATH_ALL);
    usData = (usData | ((WORD)ScalerQCCRCCompare_D_II( _D_CRC_AFTER_DDITHER, _M1 | _M2, tQC_DCC_CRC_TABLE10, 1) << 7));
    ...
    ScalerQCWaitForIDDomainEvent(_EVENT_DVS, _INPUT_PATH_ALL);
    ScalerQCWaitForIDDomainEvent(_EVENT_DVS, _INPUT_PATH_ALL);
    usData = (usData | ((WORD)ScalerQCCRCCompare_D_II( _D_CRC_AFTER_DDITHER, _M1 | _M2, tQC_DCC_CRC_TABLE11, 1) << 7));
...
bit ScalerQCICMTest(void)
{
    ...
    DebugMessageQC("5. Mode_0", 0x00);
    usData = (usData | ((WORD)ScalerQCCRCCompare_D_II( _D_CRC_AFTER_DDITHER, _M1 | _M2, tQC_ICM_CRC_TABLE0, 1) << 0));
    ...
    DebugMessageQC("5. Mode_1", 0x00);
    usData = (usData | ((WORD)ScalerQCCRCCompare_D_II( _D_CRC_AFTER_DDITHER, _M1 | _M2, tQC_ICM_CRC_TABLE1, 1) << 1));
    ...
    DebugMessageQC("5. Mode_2", 0x00);
    usData = (usData | ((WORD)ScalerQCCRCCompare_D_II( _D_CRC_AFTER_DDITHER, _M1 | _M2, tQC_ICM_CRC_TABLE2, 1) << 2));
    ...
    DebugMessageQC("5. Mode_3", 0x00);
    usData = (usData | ((WORD)ScalerQCCRCCompare_D_II( _D_CRC_AFTER_DDITHER, _M1 | _M2, tQC_ICM_CRC_TABLE3, 1) << 3));
    ...
    DebugMessageQC("5. Mode_4", 0x00);
    usData = (usData | ((WORD)ScalerQCCRCCompare_D_II( _D_CRC_AFTER_DDITHER, _M1 | _M2, tQC_ICM_CRC_TABLE4, 1) << 4));
    ...
    DebugMessageQC("5. Mode_5", 0x00);
    usData = (usData | ((WORD)ScalerQCCRCCompare_D_II( _D_CRC_AFTER_DDITHER, _M1 | _M2, tQC_ICM_CRC_TABLE5, 1) << 5));
    ...
    DebugMessageQC("5. Mode_6", 0x00);
    usData = (usData | ((WORD)ScalerQCCRCCompare_D_II( _D_CRC_AFTER_DDITHER, _M1 | _M2, tQC_ICM_CRC_TABLE6, 1) << 6));
    ...
    DebugMessageQC("5. Mode_7", 0x00);
    usData = (usData | ((WORD)ScalerQCCRCCompare_D_II( _D_CRC_AFTER_DDITHER, _M1 | _M2, tQC_ICM_CRC_TABLE7, 1) << 7));
    ...
    DebugMessageQC("5. Mode_8", 0x00);
    usData = (usData | ((WORD)ScalerQCCRCCompare_D_II( _D_CRC_AFTER_DDITHER, _M1 | _M2, tQC_ICM_CRC_TABLE8, 1) << 8));
    ...
    DebugMessageQC("5. Mode_9", 0x00);
    usData = (usData | ((WORD)ScalerQCCRCCompare_D_II( _D_CRC_AFTER_DDITHER, _M1 | _M2, tQC_ICM_CRC_TABLE9, 1) << 9));
...
bit ScalerQCCTSBRITest(void)
{
    ...
    ucData = ucData | ((BYTE)ScalerQCCRCCompare_D_II( _D_CRC_AFTER_DDITHER, _M1 | _M2, tQC_CON_BRI_DCRC_TABLE_0, 1) << 0);

    DebugMessageQC("5. Mode_1", 0x00);
    ScalerQCHighlightWindowOn();

    ScalerSetDataPortBit(P0_60_HLW_ADDR_PORT, _P0_61_PT_0E_HLW_CONTROL0, ~(_BIT7 | _BIT6), 0x00);
    ScalerSetDataPortBit(P0_60_HLW_ADDR_PORT, _P0_61_PT_11_HLW_SETSEL0, ~(_BIT2), 0x00);
    ...
    ucData = ucData | ((BYTE)ScalerQCCRCCompare_D_II( _D_CRC_AFTER_DDITHER, _M1 | _M2, tQC_CON_BRI_DCRC_TABLE_1, 1) << 1);

    DebugMessageQC("5. Mode_2", 0x00);
    ScalerSetDataPortBit(P0_60_HLW_ADDR_PORT, _P0_61_PT_0E_HLW_CONTROL0, ~(_BIT7 | _BIT6), _BIT7);
    ScalerSetDataPortBit(P0_60_HLW_ADDR_PORT, _P0_61_PT_11_HLW_SETSEL0, ~(_BIT2), _BIT2);
    ...
    ucData = ucData | ((BYTE)ScalerQCCRCCompare_D_II( _D_CRC_AFTER_DDITHER, _M1 | _M2, tQC_CON_BRI_DCRC_TABLE_2, 1) << 2);
    ...
    ucData = ucData | ((BYTE)ScalerQCCRCCompare_D_II( _D_CRC_AFTER_DDITHER, _M1 | _M2, tQC_CON_BRI_DCRC_TABLE_3, 1) << 2);
    ...
    ucData = ucData | ((BYTE)ScalerQCCRCCompare_D_II( _D_CRC_AFTER_DDITHER, _M1 | _M2, tQC_CON_BRI_DCRC_TABLE_4, 1) << 2);
...
bit ScalerQCIAPSGainTest(void)
{
    ...
    DebugMessageQC("5. Mode_0", 0x00);
    ucData = ucData | ((BYTE)ScalerQCCRCCompare_D_II( _D_CRC_AFTER_DDITHER, _M1 | _M2, tQC_IAPSGAIN_CRCTABLE_0, 1) << 0);
    ...
    ScalerSetByte(P7_E4_IAPS_GAIN_DB_CTRL_M1 , 0x02);
    DebugMessageQC("5. Mode_1", 0x00);
    ucData = ucData | ((BYTE)ScalerQCCRCCompare_D_II( _D_CRC_AFTER_DDITHER, _M1 | _M2, tQC_IAPSGAIN_CRCTABLE_1, 1) << 1);
    ...
    ScalerSetByte(P7_E4_IAPS_GAIN_DB_CTRL_M1, 0x02);
    DebugMessageQC("5. Mode_2", 0x00);
    ucData = ucData | ((BYTE)ScalerQCCRCCompare_D_II( _D_CRC_AFTER_DDITHER, _M1 | _M2, tQC_IAPSGAIN_CRCTABLE_2, 1) << 2);
    ...
    ScalerSetByte(P7_E4_IAPS_GAIN_DB_CTRL_M1, 0x02);
    DebugMessageQC("5. Mode_3", 0x00);
    ucData = ucData | ((BYTE)ScalerQCCRCCompare_D_II( _D_CRC_AFTER_DDITHER, _M1 | _M2, tQC_IAPSGAIN_CRCTABLE_3, 1) << 3);
    ...
    ScalerSetByte(P7_E4_IAPS_GAIN_DB_CTRL_M1, 0x02);
    DebugMessageQC("5. Mode_4", 0x00);
    ucData = ucData | ((BYTE)ScalerQCCRCCompare_D_II( _D_CRC_AFTER_DDITHER, _M1 | _M2, tQC_IAPSGAIN_CRCTABLE_4, 1) << 4);
    ...
    ScalerSetByte(P7_E4_IAPS_GAIN_DB_CTRL_M1, 0x02);
    DebugMessageQC("5. Mode_5", 0x00);
    ucData = ucData | ((BYTE)ScalerQCCRCCompare_D_II( _D_CRC_AFTER_DDITHER, _M1 | _M2, tQC_IAPSGAIN_CRCTABLE_5, 1) << 5);
    ...
    ScalerSetByte(P7_E4_IAPS_GAIN_DB_CTRL_M1, 0x02);
    DebugMessageQC("5. Mode_6", 0x00);
    ucData = ucData | ((BYTE)ScalerQCCRCCompare_D_II( _D_CRC_AFTER_DDITHER, _M1 | _M2, tQC_IAPSGAIN_CRCTABLE_6, 1) << 6);
    ...
    ScalerSetByte(P7_E4_IAPS_GAIN_DB_CTRL_M1, 0x02);
    DebugMessageQC("5. Mode_7", 0x00);
    ucData = ucData | ((BYTE)ScalerQCCRCCompare_D_II( _D_CRC_AFTER_DDITHER, _M1 | _M2, tQC_IAPSGAIN_CRCTABLE_7, 1) << 7);
    ...
    ScalerSetByte(P7_E4_IAPS_GAIN_DB_CTRL_M1, 0x02);
    DebugMessageQC("5. Mode_8", 0x00);
    ucData = ucData | ((BYTE)ScalerQCCRCCompare_D_II( _D_CRC_AFTER_DDITHER, _M1 | _M2, tQC_IAPSGAIN_CRCTABLE_8, 1) << 7);
    ...
    ScalerSetByte(P7_E4_IAPS_GAIN_DB_CTRL_M1, 0x02);
    DebugMessageQC("5. Mode_9", 0x00);
    ucData = ucData | ((BYTE)ScalerQCCRCCompare_D_II( _D_CRC_AFTER_DDITHER, _M1 | _M2, tQC_IAPSGAIN_CRCTABLE_9, 1) << 7);
    ...
    ScalerSetByte(P7_E4_IAPS_GAIN_DB_CTRL_M1, 0x02);
    DebugMessageQC("5. Mode_10", 0x00);
    ucData = ucData | ((BYTE)ScalerQCCRCCompare_D_II( _D_CRC_AFTER_DDITHER, _M1 | _M2, tQC_IAPSGAIN_CRCTABLE_10, 1) << 7);
    ...
    ScalerSetByte(P7_E4_IAPS_GAIN_DB_CTRL_M1, 0x02);
    DebugMessageQC("5. Mode_11", 0x00);
    ucData = ucData | ((BYTE)ScalerQCCRCCompare_D_II( _D_CRC_AFTER_DDITHER, _M1 | _M2, tQC_IAPSGAIN_CRCTABLE_11, 1) << 7);
...
bit ScalerQC3DGammaTest(void)
{
    ...
    // RandomGen
    ucData = (ucData | ((BYTE)ScalerQCCRCCompare_D_II( _D_CRC_AFTER_DDITHER, _M1|_M2, t3DGAMMA_CRC_Table0, 1) << 0));
    ...
    DebugMessageQC("5. Mode_1", 0x00);
    ucData = (ucData | ((BYTE)ScalerQCCRCCompare_D_II( _D_CRC_AFTER_DDITHER, _M1|_M2, t3DGAMMA_CRC_Table1, 1) << 1));

    // RandomGen + HLW(_OUTSIDE_WINDOW)
    ScalerSetDataPortBit(P0_60_HLW_ADDR_PORT, _P0_61_PT_0F_HLW_CONTROL2, ~(_BIT3 | _BIT2), _BIT3);
    DebugMessageQC("5. Mode_2", 0x00);
    ucData = (ucData | ((BYTE)ScalerQCCRCCompare_D_II( _D_CRC_AFTER_DDITHER, _M1|_M2, t3DGAMMA_CRC_Table2, 1) << 2));
...
// Output Value : _TEST_PASS or _TEST_FAIL
//--------------------------------------------------
bit ScalerQCCRCCompare_D_II(EnumDCRCPosition enumPosition, BYTE ucSourceSel, BYTE *ucCRC, BYTE ucFrameNum)
{
    BYTE i = 0, j = 0, k = 0;
        ...
        for(j = 0; j < 3; j++)
        {
            if((ucSourceSel & ucOrder[j]) != 0)
            {
                for(i = 6*j; i < 6*(j + 1); i++)
                {
                    ...
                    {
                        ScalerQCPrintCRC_D_II(k, j, ucReadCRC + 6*j, 6);
                        bFlag = _TEST_FAIL;
                        break;
                    }
                }
