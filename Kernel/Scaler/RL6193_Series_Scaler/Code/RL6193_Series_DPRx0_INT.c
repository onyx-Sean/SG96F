...
#define __RL6193_SERIES_DPRX0_INT__
...
void ScalerDpRx0Tp2SetPhy_EXINT0(void) using 1
{
    ...
    if(g_ucDpRx0LinkRate == _DP_LINK_HBR2)
    {
        ...
        ucAutoVCOBand = ScalerGetByte_EXINT(PB_BF_LANE0_A_CDR_02);

        // Manually Reload FLD Band + 4
        ScalerSetByte_EXINT(PB_BE_LANE0_A_CDR_01, (ucAutoVCOBand + 4));
        ...
        for(g_ucDpRx0Temp = 0; g_ucDpRx0Temp <= 10; g_ucDpRx0Temp++)
        {
            ...
            if(ScalerGetBit_EXINT(PB_50_DP_SIG_DET_0, _BIT6) == _BIT6)
            {
                usVCOBandScanCount = ((((WORD)ScalerGetByte_EXINT(PB_53_DP_SIG_DET_3)) << 8) | ScalerGetByte_EXINT(PB_54_DP_SIG_DET_4));
        ...
        ScalerSetByte_EXINT(PB_BE_LANE0_A_CDR_01, ucAutoVCOBand);
        ...
        for(g_ucDpRx0Temp = 0; g_ucDpRx0Temp <= 10; g_ucDpRx0Temp++)
        {
            ...
            if((ScalerGetBit_EXINT(PB_50_DP_SIG_DET_0, _BIT6) == _BIT6) || (usVCOBandScanCount == 0))
            {
                break;
            }
        }
        ...
        if((usVCOBandScanCount != 0) && (ScalerGetBit_EXINT(PB_50_DP_SIG_DET_0, _BIT6) == _BIT6))
        {
            g_usDpRx0ClockCount1 = ((((WORD)ScalerGetByte_EXINT(PB_53_DP_SIG_DET_3)) << 8) | ScalerGetByte_EXINT(PB_54_DP_SIG_DET_4));

            usVCOBandDiff = (abs(usVCOBandScanCount - g_usDpRx0ClockCount1) >> 2);
        }
        else
        {
            usVCOBandDiff = 0;
        ...
        if(usVCOBandDiff != 0)
        {
            if(g_usDpRx0ClockCount1 < g_usDpRx0ClockCount)
            {
                ucBestVCOBand = ucAutoVCOBand + (((g_usDpRx0ClockCount - g_usDpRx0ClockCount1) / usVCOBandDiff) + 1);
            }
            else
            {
                ucBestVCOBand = ucAutoVCOBand - ((g_usDpRx0ClockCount1 - g_usDpRx0ClockCount) / usVCOBandDiff);
            }
        }
        else
        {
...
void ScalerDpRx0RebuildPhy_WDINT(BYTE ucDpLinkRate, BYTE ucDpcdLane) using 3
{
    ...
    if(ucDpLinkRate == _DP_LINK_HBR2)
    {
        ...
        if(g_pucDpRx0LEMaxTemp[pData_EXINT[0]] > g_pucDpRx0LEMinTemp[pData_EXINT[0]])
        {
            if(g_pucDpRx0LEMinTemp[pData_EXINT[0]] < 10)
            {
                g_pucDpRx0LEMinTemp[pData_EXINT[0]] = g_pucDpRx0LEMinTemp[pData_EXINT[0]] + 2;
            }
            else if(g_pucDpRx0LEMinTemp[pData_EXINT[0]] < 12)
            {
                g_pucDpRx0LEMinTemp[pData_EXINT[0]]++;
            }
        }
        ...
        {
            if(abs(g_pucDpRx0LEMaxTemp[pData_EXINT[0]] - g_pucDpRx0LEMinTemp[pData_EXINT[0]]) == 1)
            {
                if(g_pucDpRx0LEMinTemp[pData_EXINT[0]] < 10)
                {
                    g_pucDpRx0LEMinTemp[pData_EXINT[0]] = g_pucDpRx0LEMinTemp[pData_EXINT[0]] + 2;
                }
                else if(g_pucDpRx0LEMinTemp[pData_EXINT[0]] < 13)
                {
                    g_pucDpRx0LEMinTemp[pData_EXINT[0]]++;
                }
            }
            else if(abs(g_pucDpRx0LEMaxTemp[pData_EXINT[0]] - g_pucDpRx0LEMinTemp[pData_EXINT[0]]) > 1)
            {
                if(g_pucDpRx0LEMinTemp[pData_EXINT[0]] < 12)
                {
                    g_pucDpRx0LEMinTemp[pData_EXINT[0]] = g_pucDpRx0LEMinTemp[pData_EXINT[0]] + 2;
                }
                else if(g_pucDpRx0LEMinTemp[pData_EXINT[0]] < 13)
        ...
        {
            if(g_pucDpRx0Tap1MaxTemp[pData_EXINT[0]] > 10)
            {
                g_pucDpRx0Tap1MaxTemp[pData_EXINT[0]] = 0x06;

                if(g_pucDpRx0LEMinTemp[pData_EXINT[0]] < 15)
                {
                    g_pucDpRx0LEMinTemp[pData_EXINT[0]]++;
                }
            }
        ...
        // Reload LE
        if(ScalerDpRx0GetDpcdInfo_WDINT(0x00, 0x01, 0x03) == 0x06)
        {
            ScalerSetBit_EXINT(P1D_A2_L0_LIMIT_INIT, ~(_BIT3 | _BIT2 | _BIT1 | _BIT0), (g_pucDpRx0LEMaxTemp[0] & (_BIT3 | _BIT2 | _BIT1 | _BIT0)));
            ScalerSetBit_EXINT(P1D_A3_L0_INIT_1, ~_BIT6, ((g_pucDpRx0LEMaxTemp[0] << 2) & _BIT6));
        }
        else
        {
            ScalerSetBit_EXINT(P1D_A2_L0_LIMIT_INIT, ~(_BIT3 | _BIT2 | _BIT1 | _BIT0), (g_pucDpRx0LEMinTemp[0] & (_BIT3 | _BIT2 | _BIT1 | _BIT0)));
        ...
        if(ScalerDpRx0GetDpcdInfo_WDINT(0x00, 0x01, 0x04) == 0x06)
        {
            ScalerSetBit_EXINT(P1D_B2_L1_LIMIT_INIT, ~(_BIT3 | _BIT2 | _BIT1 | _BIT0), (g_pucDpRx0LEMaxTemp[1] & (_BIT3 | _BIT2 | _BIT1 | _BIT0)));
            ScalerSetBit_EXINT(P1D_B3_L1_INIT_1, ~_BIT6, ((g_pucDpRx0LEMaxTemp[1] << 2) & _BIT6));
        }
        else
        {
            ScalerSetBit_EXINT(P1D_B2_L1_LIMIT_INIT, ~(_BIT3 | _BIT2 | _BIT1 | _BIT0), (g_pucDpRx0LEMinTemp[1] & (_BIT3 | _BIT2 | _BIT1 | _BIT0)));
        ...
        if(ScalerDpRx0GetDpcdInfo_WDINT(0x00, 0x01, 0x05) == 0x06)
        {
            ScalerSetBit_EXINT(P1D_C2_L2_LIMIT_INIT, ~(_BIT3 | _BIT2 | _BIT1 | _BIT0), (g_pucDpRx0LEMaxTemp[2] & (_BIT3 | _BIT2 | _BIT1 | _BIT0)));
            ScalerSetBit_EXINT(P1D_C3_L2_INIT_1, ~_BIT6, ((g_pucDpRx0LEMaxTemp[2] << 2) & _BIT6));
        }
        else
        {
            ScalerSetBit_EXINT(P1D_C2_L2_LIMIT_INIT, ~(_BIT3 | _BIT2 | _BIT1 | _BIT0), (g_pucDpRx0LEMinTemp[2] & (_BIT3 | _BIT2 | _BIT1 | _BIT0)));
        ...
        if(ScalerDpRx0GetDpcdInfo_WDINT(0x00, 0x01, 0x06) == 0x06)
        {
            ScalerSetBit_EXINT(P1D_D2_L3_LIMIT_INIT, ~(_BIT3 | _BIT2 | _BIT1 | _BIT0), (g_pucDpRx0LEMaxTemp[3] & (_BIT3 | _BIT2 | _BIT1 | _BIT0)));
            ScalerSetBit_EXINT(P1D_D3_L3_INIT_1, ~_BIT6, ((g_pucDpRx0LEMaxTemp[3] << 2) & _BIT6));
        }
        else
        {
            ScalerSetBit_EXINT(P1D_D2_L3_LIMIT_INIT, ~(_BIT3 | _BIT2 | _BIT1 | _BIT0), (g_pucDpRx0LEMinTemp[3] & (_BIT3 | _BIT2 | _BIT1 | _BIT0)));
