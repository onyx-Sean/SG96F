...
#define __RL6193_SERIES_DPRX1_INT__
...
void ScalerDpRx1Tp2SetPhy_EXINT0(void) using 1
{
    ...
    if(g_ucDpRx1LinkRate == _DP_LINK_HBR2)
    {
        ...
        ucAutoVCOBand = ScalerGetByte_EXINT(PB0_BF_LANE0_A_CDR_02);

        // Manually Reload FLD Band + 4
        ScalerSetByte_EXINT(PB0_BE_LANE0_A_CDR_01, (ucAutoVCOBand + 4));
        ...
        for(g_ucDpRx1Temp = 0; g_ucDpRx1Temp <= 10; g_ucDpRx1Temp++)
        {
            ...
            if(ScalerGetBit_EXINT(PB0_50_DP_SIG_DET_0, _BIT6) == _BIT6)
            {
                usVCOBandScanCount = ((((WORD)ScalerGetByte_EXINT(PB0_53_DP_SIG_DET_3)) << 8) | ScalerGetByte_EXINT(PB0_54_DP_SIG_DET_4));
        ...
        ScalerSetByte_EXINT(PB0_BE_LANE0_A_CDR_01, ucAutoVCOBand);
        ...
        for(g_ucDpRx1Temp = 0; g_ucDpRx1Temp <= 10; g_ucDpRx1Temp++)
        {
            ...
            if((ScalerGetBit_EXINT(PB0_50_DP_SIG_DET_0, _BIT6) == _BIT6) || (usVCOBandScanCount == 0))
            {
                break;
            }
        }

        // Measure Band Difference
        if((usVCOBandScanCount != 0) && (ScalerGetBit_EXINT(PB0_50_DP_SIG_DET_0, _BIT6) == _BIT6))
        {
            g_usDpRx1ClockCount1 = ((((WORD)ScalerGetByte_EXINT(PB0_53_DP_SIG_DET_3)) << 8) | ScalerGetByte_EXINT(PB0_54_DP_SIG_DET_4));

            usVCOBandDiff = (abs(usVCOBandScanCount - g_usDpRx1ClockCount1) >> 2);
        }
        else
        {
            usVCOBandDiff = 0;
        ...
        if(usVCOBandDiff != 0)
        {
            if(g_usDpRx1ClockCount1 < g_usDpRx1ClockCount)
            {
                ucBestVCOBand = ucAutoVCOBand + (((g_usDpRx1ClockCount - g_usDpRx1ClockCount1) / usVCOBandDiff) + 1);
            }
            else
            {
                ucBestVCOBand = ucAutoVCOBand - ((g_usDpRx1ClockCount1 - g_usDpRx1ClockCount) / usVCOBandDiff);
            }
        }
        else
        {
...
void ScalerDpRx1RebuildPhy_WDINT(BYTE ucDpLinkRate, BYTE ucDpcdLane) using 3
{
    ...
    if(ucDpLinkRate == _DP_LINK_HBR2)
    {
        ...
        // Waiting for VCO Stable
        for(pData_EXINT[0] = 0; pData_EXINT[0] <= 2; pData_EXINT[0]++)
        {
            Delay5us_EXINT(g_ucDelay5usN);
        }

        // [3] reg_cp_en_manual = 1'b1 --> Enable cp_en_manual
        ScalerSetBit_EXINT(PB0_F9_LANE0_A_CDR_03, ~_BIT3, _BIT3);
        ...
        if(g_pucDpRx1LEMaxTemp[pData_EXINT[0]] > g_pucDpRx1LEMinTemp[pData_EXINT[0]])
        {
            if(g_pucDpRx1LEMinTemp[pData_EXINT[0]] < 10)
            {
                g_pucDpRx1LEMinTemp[pData_EXINT[0]] = g_pucDpRx1LEMinTemp[pData_EXINT[0]] + 2;
            }
            else if(g_pucDpRx1LEMinTemp[pData_EXINT[0]] < 12)
            {
                g_pucDpRx1LEMinTemp[pData_EXINT[0]]++;
            }
        }
        ...
        for(pData_EXINT[0] = 1; pData_EXINT[0] <= 3; pData_EXINT[0]++)
        {
            if(abs(g_pucDpRx1LEMaxTemp[pData_EXINT[0]] - g_pucDpRx1LEMinTemp[pData_EXINT[0]]) == 1)
            {
                if(g_pucDpRx1LEMinTemp[pData_EXINT[0]] < 10)
                {
                    g_pucDpRx1LEMinTemp[pData_EXINT[0]] = g_pucDpRx1LEMinTemp[pData_EXINT[0]] + 2;
                }
                else if(g_pucDpRx1LEMinTemp[pData_EXINT[0]] < 13)
                {
                    g_pucDpRx1LEMinTemp[pData_EXINT[0]]++;
                }
            }
            else if(abs(g_pucDpRx1LEMaxTemp[pData_EXINT[0]] - g_pucDpRx1LEMinTemp[pData_EXINT[0]]) > 1)
            {
                if(g_pucDpRx1LEMinTemp[pData_EXINT[0]] < 12)
                {
                    g_pucDpRx1LEMinTemp[pData_EXINT[0]] = g_pucDpRx1LEMinTemp[pData_EXINT[0]] + 2;
                }
                else if(g_pucDpRx1LEMinTemp[pData_EXINT[0]] < 13)
        ...
        {
            if(g_pucDpRx1Tap1MaxTemp[pData_EXINT[0]] > 10)
            {
                g_pucDpRx1Tap1MaxTemp[pData_EXINT[0]] = 0x06;

                if(g_pucDpRx1LEMinTemp[pData_EXINT[0]] < 15)
                {
                    g_pucDpRx1LEMinTemp[pData_EXINT[0]]++;
                }
            }
        ...
        // Reload LE
        if(ScalerDpRx1GetDpcdInfo_WDINT(0x00, 0x01, 0x03) == 0x06)
        {
            ScalerSetBit_EXINT(P7A_A2_L0_LIMIT_INIT, ~(_BIT3 | _BIT2 | _BIT1 | _BIT0), (g_pucDpRx1LEMaxTemp[0] & (_BIT3 | _BIT2 | _BIT1 | _BIT0)));
            ScalerSetBit_EXINT(P7A_A3_L0_INIT_1, ~_BIT6, ((g_pucDpRx1LEMaxTemp[0] << 2) & _BIT6));
        }
        else
        {
            ScalerSetBit_EXINT(P7A_A2_L0_LIMIT_INIT, ~(_BIT3 | _BIT2 | _BIT1 | _BIT0), (g_pucDpRx1LEMinTemp[0] & (_BIT3 | _BIT2 | _BIT1 | _BIT0)));
        ...
        if(ScalerDpRx1GetDpcdInfo_WDINT(0x00, 0x01, 0x04) == 0x06)
        {
            ScalerSetBit_EXINT(P7A_B2_L1_LIMIT_INIT, ~(_BIT3 | _BIT2 | _BIT1 | _BIT0), (g_pucDpRx1LEMaxTemp[1] & (_BIT3 | _BIT2 | _BIT1 | _BIT0)));
            ScalerSetBit_EXINT(P7A_B3_L1_INIT_1, ~_BIT6, ((g_pucDpRx1LEMaxTemp[1] << 2) & _BIT6));
        }
        else
        {
            ScalerSetBit_EXINT(P7A_B2_L1_LIMIT_INIT, ~(_BIT3 | _BIT2 | _BIT1 | _BIT0), (g_pucDpRx1LEMinTemp[1] & (_BIT3 | _BIT2 | _BIT1 | _BIT0)));
        ...
        if(ScalerDpRx1GetDpcdInfo_WDINT(0x00, 0x01, 0x05) == 0x06)
        {
            ScalerSetBit_EXINT(P7A_C2_L2_LIMIT_INIT, ~(_BIT3 | _BIT2 | _BIT1 | _BIT0), (g_pucDpRx1LEMaxTemp[2] & (_BIT3 | _BIT2 | _BIT1 | _BIT0)));
            ScalerSetBit_EXINT(P7A_C3_L2_INIT_1, ~_BIT6, ((g_pucDpRx1LEMaxTemp[2] << 2) & _BIT6));
        }
        else
        {
            ScalerSetBit_EXINT(P7A_C2_L2_LIMIT_INIT, ~(_BIT3 | _BIT2 | _BIT1 | _BIT0), (g_pucDpRx1LEMinTemp[2] & (_BIT3 | _BIT2 | _BIT1 | _BIT0)));
        ...
        if(ScalerDpRx1GetDpcdInfo_WDINT(0x00, 0x01, 0x06) == 0x06)
        {
            ScalerSetBit_EXINT(P7A_D2_L3_LIMIT_INIT, ~(_BIT3 | _BIT2 | _BIT1 | _BIT0), (g_pucDpRx1LEMaxTemp[3] & (_BIT3 | _BIT2 | _BIT1 | _BIT0)));
            ScalerSetBit_EXINT(P7A_D3_L3_INIT_1, ~_BIT6, ((g_pucDpRx1LEMaxTemp[3] << 2) & _BIT6));
        }
        else
        {
            ScalerSetBit_EXINT(P7A_D2_L3_LIMIT_INIT, ~(_BIT3 | _BIT2 | _BIT1 | _BIT0), (g_pucDpRx1LEMinTemp[3] & (_BIT3 | _BIT2 | _BIT1 | _BIT0)));
