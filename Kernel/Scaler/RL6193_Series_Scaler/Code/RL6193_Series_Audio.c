...
void ScalerAudioD1SetAudioPLL(void)
{
    ...
    // Initial VCO Band = 10
    ScalerSetDataPortBit(P70_C9_HDMI_AP, _P70_CA_PT_3A_PORT_PAGE70_HDMI_DPCR2, ~(_BIT4 | _BIT3), _BIT4);
...
void ScalerAudioD1HDMIAudioInitial(void)
{
    ...
    // Enable FIFO Boundary Tracking, Enable Trend Tracking
    ScalerSetDataPortBit(P70_C9_HDMI_AP, _P70_CA_PT_15_PORT_PAGE70_HDMI_PSCR, ~(_BIT7 | _BIT6 | _BIT5 | _BIT3 | _BIT2), (_BIT7 | _BIT6 | _BIT5 | _BIT3 | _BIT2));
    ...
    // Set Boundary Address = 5 for Boundary Tracking
    ScalerSetDataPortBit(P70_C9_HDMI_AP, _P70_CA_PT_1B_PORT_PAGE70_HDMI_FBR, ~(_BIT2 | _BIT1 | _BIT0), (_BIT2 | _BIT0));
    ...
    // Set P code of trend
    ScalerSetDataPortByte(P70_C9_HDMI_AP, _P70_CA_PT_22_PORT_PAGE70_HDMI_PCTPSR0, 0x7F);
    ...
    // Set P code of boundary
    ScalerSetDataPortByte(P70_C9_HDMI_AP, _P70_CA_PT_26_PORT_PAGE70_HDMI_PCBPSR0, 0x7F);
