...
//--------------------------------------------------
#define GET_DIGITAL_COLOR_SPACE_PREVALUE()                  (g_stDigitalColorInfo.ucDigitalColorSpacePreValue)
#define SET_DIGITAL_COLOR_SPACE_PREVALUE(X)                 (g_stDigitalColorInfo.ucDigitalColorSpacePreValue = (X))

#define GET_DIGITAL_COLOR_DEPTH_PREVALUE()                  (g_stDigitalColorInfo.b3DigitalColorDepthPreValue)
#define SET_DIGITAL_COLOR_DEPTH_PREVALUE(X)                 (g_stDigitalColorInfo.b3DigitalColorDepthPreValue = (X))

#define GET_DIGITAL_COLORIMETRY_PREVALUE()                  (g_stDigitalColorInfo.b4DigitalColorimetryPreValue)
#define SET_DIGITAL_COLORIMETRY_PREVALUE(X)                 (g_stDigitalColorInfo.b4DigitalColorimetryPreValue = (X))

#define GET_DIGITAL_COLORIMETRY_EXT_PREVALUE()              (g_stDigitalColorInfo.b4DigitalColorimetryExtPreValue)
#define SET_DIGITAL_COLORIMETRY_EXT_PREVALUE(X)             (g_stDigitalColorInfo.b4DigitalColorimetryExtPreValue = (X))

#define GET_DIGITAL_QUANTIZATION_PREVALUE()                 (g_stDigitalColorInfo.b2DigitalQuantizationPreValue)
#define SET_DIGITAL_QUANTIZATION_PREVALUE(X)                (g_stDigitalColorInfo.b2DigitalQuantizationPreValue = (X))
...
#define GET_DIGITAL_COLORIMETRY_CHANGED()                   (g_stDigitalColorInfoChanged.b1DigitalColorimetryChanged)
#define SET_DIGITAL_COLORIMETRY_CHANGED()                   (g_stDigitalColorInfoChanged.b1DigitalColorimetryChanged = _TRUE)
#define CLR_DIGITAL_COLORIMETRY_CHANGED()                   (g_stDigitalColorInfoChanged.b1DigitalColorimetryChanged = _FALSE)

#define GET_DIGITAL_COLORIMETRY_EXT_CHANGED()               (g_stDigitalColorInfoChanged.b1DigitalColorimetryExtChanged)
#define SET_DIGITAL_COLORIMETRY_EXT_CHANGED()               (g_stDigitalColorInfoChanged.b1DigitalColorimetryExtChanged = _TRUE)
#define CLR_DIGITAL_COLORIMETRY_EXT_CHANGED()               (g_stDigitalColorInfoChanged.b1DigitalColorimetryExtChanged = _FALSE)

#define GET_DIGITAL_QUANTIZATION_CHANGED()                  (g_stDigitalColorInfoChanged.b1DigitalQuantizationChanged)
#define SET_DIGITAL_QUANTIZATION_CHANGED()                  (g_stDigitalColorInfoChanged.b1DigitalQuantizationChanged = _TRUE)
#define CLR_DIGITAL_QUANTIZATION_CHANGED()                  (g_stDigitalColorInfoChanged.b1DigitalQuantizationChanged = _FALSE)
#endif
...
extern WORD idata g_usTmdsOffLineMeasureClk;
...
extern StructDigitalColorInfoChanged g_stDigitalColorInfoChanged;
