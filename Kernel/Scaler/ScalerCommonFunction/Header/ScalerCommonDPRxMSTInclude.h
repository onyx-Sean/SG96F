...
#define SET_DP_MST_HPD_IRQ()                                                                    ((g_enumDpMSTCapablePort == _DP_MST_RX0_PORT) ? ScalerDpRx0HotPlugDuration(_DP_HPD_IRQ_TIME) : ScalerDpRx1HotPlugDuration(_DP_HPD_IRQ_TIME))
...
#define SET_DP_MST_HPD_IRQ()                                                                    (ScalerDpRx0HotPlugDuration(_DP_HPD_IRQ_TIME))
...
#define SET_DP_MST_HPD_IRQ()                                                                    (ScalerDpRx1HotPlugDuration(_DP_HPD_IRQ_TIME))
