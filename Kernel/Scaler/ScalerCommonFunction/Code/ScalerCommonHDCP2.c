...
void ScalerHdcp2ResetProc(BYTE ucInputPort);
...
void ScalerHdcp2Handler(void)
{
#if((_D0_INPUT_PORT_TYPE == _D0_DP_PORT) && (_DP_HDCP_2_2_SUPPORT == _ON))
    ScalerDpRx0Hdcp2Handler();
#endif

#if((_D1_INPUT_PORT_TYPE == _D1_DP_PORT) && (_DP_HDCP_2_2_SUPPORT == _ON))
    ScalerDpRx1Hdcp2Handler();
#elif(((_D1_INPUT_PORT_TYPE == _D1_HDMI_PORT) || (_D1_INPUT_PORT_TYPE == _D1_MHL_PORT)) && (_TMDS_HDCP_2_2_SUPPORT == _ON))
...
//--------------------------------------------------
// Description  : HDCP 2.2 Reset Process
// Input Value  : None
// Output Value : None
//--------------------------------------------------
void ScalerHdcp2ResetProc(BYTE ucInputPort)
...
#if((_D1_INPUT_PORT_TYPE == _D1_DP_PORT) || (_D1_INPUT_PORT_TYPE == _D1_HDMI_PORT) || (_D1_INPUT_PORT_TYPE == _D1_MHL_PORT))
