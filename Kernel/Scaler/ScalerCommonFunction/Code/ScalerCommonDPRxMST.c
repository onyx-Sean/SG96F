...
void ScalerDpRxMstUpReplyAnal(void)
{
    ...
    if(GET_DP_RX_UP_REPLY_ANAL() == _TRUE)
    {
        ...
        if((ScalerDpRxMstCheckMsgCRC(_DP_UP_REPLY_MSG) == _TRUE) || (GET_DP_RX_UP_REQUEST_CRC_FAIL_RETRY_NUM() >= 5))
        {
...
void ScalerDpRxMstStreamMuxRestore_EXINT0(EnumDpStreamSourceNum enumSourceNum) using 1
{
    switch(enumSourceNum)
    {
        case _DP_ST_SOURCE1:
            ...
            // Set ST_Source1
            SET_REG_DP_RX_MST_ST1_SOURCE_STATUS(ScalerDpRxMstStreamMuxCheck_EXINT0(enumSourceNum));
        ...
        case _DP_ST_SOURCE2:
            ...
            // Set ST_Source2
            SET_REG_DP_RX_MST_ST2_SOURCE_STATUS(ScalerDpRxMstStreamMuxCheck_EXINT0(enumSourceNum));
        ...
        case _DP_ST_SOURCE3:
            ...
            // Set ST_Source3
            SET_REG_DP_RX_MST_ST3_SOURCE_STATUS(ScalerDpRxMstStreamMuxCheck_EXINT0(enumSourceNum));
        ...
        case _DP_ST_SOURCE4:
            ...
            // Set ST_Source4
            SET_REG_DP_RX_MST_ST4_SOURCE_STATUS(ScalerDpRxMstStreamMuxCheck_EXINT0(enumSourceNum));
        ...
        case _DP_ST_SOURCE5:
            ...
            // Set ST_Source5
            SET_REG_DP_RX_MST_ST5_SOURCE_STATUS(ScalerDpRxMstStreamMuxCheck_EXINT0(enumSourceNum));
