...
bit ScalerMeasureTimingChange(EnumSourceTypeDef enumSourceType);
    ...
    if(ScalerGetBit(P30_02_MEAS_CTL1, _BIT7) == 0x00)
    {
...
#endif
        {
            ...
            if(GET_FREESYNC_ENABLED() == _TRUE)
            {
                ...
                {
                    g_stInputTimingData.usVTotal = ScalerDpGetVSPeriod();
                    g_stInputTimingData.usVFreq = ScalerDpGetVFreq();
                }
                else
#endif
                {
