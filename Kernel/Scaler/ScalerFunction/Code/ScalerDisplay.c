...
void ScalerDisplayLvdsTxDataSel(void)
{
    ...
    {
        ScalerSetBit(PD5_26_LVDS_PORTA_CTRL6, ~(_BIT5 | _BIT4 | _BIT3 | _BIT2 | _BIT1 | _BIT0), (_BIT4 | _BIT3 | _BIT2 | _BIT1 | _BIT0));
        ScalerSetBit(PD5_36_LVDS_PORTB_CTRL6, ~(_BIT5 | _BIT4 | _BIT3 | _BIT2 | _BIT1 | _BIT0), (_BIT4 | _BIT3 | _BIT2 | _BIT1 | _BIT0));
    }
...
#elif(_LVDS_PORT_SEL == _LVDS_8_PORT_ABCDEFGH)//ybm

    ScalerSetByte(P39_02_LVDS_DISPLAY_CONV_CTRL1, ((_LVDS_PORT_MIRROR == _DISABLE) ? 0x23 : 0x76));
    ScalerSetByte(P39_03_LVDS_DISPLAY_CONV_CTRL2, ((_LVDS_PORT_MIRROR == _DISABLE) ? 0x01 : 0x54));
...
void ScalerDisplaySetDVFreq(void)
{
    switch(GET_MEMORY_DVF_SELECT())
    {
        case _1_IVF:
            ...
            if(GET_FREESYNC_ENABLED() == _TRUE)
            {
                if(g_usFREESYNCVFreq == 590)
                {
                    g_usFREESYNCVFreq = 600;
                }
