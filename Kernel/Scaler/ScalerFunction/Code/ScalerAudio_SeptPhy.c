...
void ScalerAudioSetADCAudioPLL(void)
{
    ...
    ScalerSetByte(PBF_A1_MN_SCLKG_DIVM, 0x36);
    ...
    // Set Offset
    ScalerSetBit(PBF_A4_MN_SCLKG_OFFS_H, ~(_BIT2 | _BIT1 | _BIT0), 0x07);
    ScalerSetByte(PBF_A5_MN_SCLKG_OFFS_M, 0x62);
    ScalerSetByte(PBF_A6_MN_SCLKG_OFFS_L, 0xE9);
