...
// Ultra HDR Option
//-------------------------------------------------
#if((_DP_ULTRA_HDR_SUPPORT == _ON) || (_HDMI_ULTRA_HDR_SUPPORT == _ON))
#define _ULTRA_HDR_SUPPORT                                      _ON
#else
...
#define _EDID_D0_MHL_ADDRESS_EEPROM                             (_EDID_D6_ADDRESS_EEPROM + ((_D6_EMBEDDED_DDCRAM_LOCATION == _EDID_TABLE_LOCATION_SYSTEM_EEPROM) ? _D6_EMBEDDED_DDCRAM_SIZE : 0))
...
#define _EDID_D0_MHL_ADDRESS_FLASH                              (_EDID_D6_ADDRESS_FLASH + ((_D6_EMBEDDED_DDCRAM_LOCATION == _EDID_TABLE_LOCATION_FLASH) ? _D6_EMBEDDED_DDCRAM_SIZE : 0))
...
#define _HDCP_2_2_SUPPORT                                       _ON    // If define _HDCP_2_2_SUPPORT == _OFF, Need cancel RL6369 project link ?CO?RL6369_SERIES_HDCP2
...
#else
#define _HDCP_2_2_SUPPORT                                       _OFF   // If define _HDCP_2_2_SUPPORT == _OFF, Need cancel RL6369 project link ?CO?RL6369_SERIES_HDCP2
...
//-------------------------------------------------
#if((_TYPEC_PORT_ROLE == _TYPEC_PORT_SRC_ONLY) || (_TYPEC_PORT_ROLE == _TYPEC_PORT_DRP))
#define _TYPEC_SRC_DEF_CUR                                      _TYPEC_SRC_DEF_1P5A
#else
#define _TYPEC_SRC_DEF_CUR                                      _TYPEC_SRC_DEF_USB
#endif

//-------------------------------------------------
// Type C DRP Preference Option
//-------------------------------------------------
#if(_TYPEC_PORT_ROLE == _TYPEC_PORT_DRP)
#define _TYPEC_DRP_PREFER                                       _TYPEC_DRP_TRY_SNK
#else
#define _TYPEC_DRP_PREFER                                       _TYPEC_DRP_NO_PREFERENCE
#endif
...
//-------------------------------------------------
// Billboard Option (remove later)
//-------------------------------------------------
#ifndef _BILLBOARD_SUPPORT
#define _BILLBOARD_SUPPORT                                      _OFF
#endif
