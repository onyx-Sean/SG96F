...
//--------------------------------------------------
#define _TYPEC_VERSION_NULL                               0x00
#define _TYPEC_VERSION_1_1                                0x01
#define _TYPEC_VERSION_1_2                                0x02
...
//  Type C Port Type
//--------------------------------------------------
#define _TYPEC_PORT_SRC_ONLY                              0x00
#define _TYPEC_PORT_SNK_ONLY                              0x01
#define _TYPEC_PORT_DRP                                   0x02

//--------------------------------------------------
//  Type C DRP Port Power Role Preference
//--------------------------------------------------
#define _TYPEC_DRP_NO_PREFERENCE                          0x00
#define _TYPEC_DRP_TRY_SNK                                0x01
#define _TYPEC_DRP_TRY_SRC                                0x02

//--------------------------------------------------
//  Type C Port SRC Default Current Provide
//--------------------------------------------------
#define _TYPEC_SRC_DEF_USB                                0x00
#define _TYPEC_SRC_DEF_1P5A                               0x01
#define _TYPEC_SRC_DEF_3P0A                               0x02

//--------------------------------------------------
//  Type C Port Accessry Support
//--------------------------------------------------
#define _TYPEC_ACC_NO_SUPPORT                             0x00
#define _TYPEC_ACC_POWER                                  0x01
#define _TYPEC_ACC_AUDIO                                  0x02
#define _TYPEC_ACC_AUDIO_POWER                            0x03
#define _TYPEC_ACC_DEBUG                                  0x04
#define _TYPEC_ACC_DEBUG_POWER                            0x05
#define _TYPEC_ACC_DEBUG_AUDIO                            0x06
#define _TYPEC_ACC_ALL                                    0x07
...
#define _AUX_LDO_VOL_GEN_2_HBR3                           2
...
//  GDI DFE TYPE Define
//--------------------------------------------------
#define _ADAPTIVE_DFE                                     0
#define _PASSIVE_DFE                                      1
...
//--------------------------------------------------
// Definitions of Type-C Pinassignment Type Auto Detection Mode
//--------------------------------------------------
#define _TYPE_C_PINCFG_AUTO_MODE_FACING_USBHUB            0
#define _TYPE_C_PINCFG_AUTO_MODE_FACING_SOURCE            1
