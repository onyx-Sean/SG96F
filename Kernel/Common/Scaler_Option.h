...
#if((_SCALER_TYPE == _RL6193_SERIES) || (_SCALER_TYPE == _RL6410_SERIES) || (_SCALER_TYPE == _RL6449_SERIES) || (_SCALER_TYPE == _RLE0779_SERIES))
...
//--------------------------------------------------
    ...
    (_DP_SUPPORT == _ON) ||\
    ((_DP_TYPE_C_SUPPORT == _ON) && (_PORT_CONTROLLER_EMBEDDED_SUPPORT == _ON)))
