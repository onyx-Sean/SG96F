...
//****************************************************************************
//--------------------------------------------------
// Definitions of Type-C Config Type
//--------------------------------------------------
#define _TYPE_C_UFP_U                           0
#define _TYPE_C_DFP_U                           1

//--------------------------------------------------
//  Type-C Pin Assignment Mode
//--------------------------------------------------
#define _TYPE_C_PIN_ASSIGNMENT_NONE             0x00
#define _TYPE_C_PIN_ASSIGNMENT_A                0x01
#define _TYPE_C_PIN_ASSIGNMENT_B                0x02
#define _TYPE_C_PIN_ASSIGNMENT_C                0x04
#define _TYPE_C_PIN_ASSIGNMENT_D                0x08
#define _TYPE_C_PIN_ASSIGNMENT_E                0x10
#define _TYPE_C_PIN_ASSIGNMENT_F                0x20
#define _TYPE_C_PIN_ASSIGNMENT_CD               0x0C
...
typedef enum
{
    _LOCAL_DIMMING_HDR_1X8_MODE,
    _LOCAL_DIMMING_HDR_2X8_MODE,
