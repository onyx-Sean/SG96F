...
#if((_D0_INPUT_PORT_TYPE == _D0_DP_PORT) || (_D1_INPUT_PORT_TYPE == _D1_DP_PORT) || (_D2_INPUT_PORT_TYPE == _D2_DP_PORT))
...
#if(((_D0_INPUT_PORT_TYPE == _D0_DP_PORT) + (_D1_INPUT_PORT_TYPE == _D1_DP_PORT) + (_D2_INPUT_PORT_TYPE == _D2_DP_PORT)) == 1)
#define _DP_EMBEDDED_SWITCH_SUPPORT_TYPE            _DP_EMBEDDED_SWITCH_1_DP
#elif(((_D0_INPUT_PORT_TYPE == _D0_DP_PORT) + (_D1_INPUT_PORT_TYPE == _D1_DP_PORT) + (_D2_INPUT_PORT_TYPE == _D2_DP_PORT)) == 2)
#define _DP_EMBEDDED_SWITCH_SUPPORT_TYPE            _DP_EMBEDDED_SWITCH_2_DP
#endif
#elif(_SCALER_TYPE == _RL6492_SERIES)
#if(((_D1_INPUT_PORT_TYPE == _D1_DP_PORT) + (_D2_INPUT_PORT_TYPE == _D2_DP_PORT)) == 1)
#define _DP_EMBEDDED_SWITCH_SUPPORT_TYPE            _DP_EMBEDDED_SWITCH_1_DP
#elif(((_D1_INPUT_PORT_TYPE == _D1_DP_PORT) + (_D2_INPUT_PORT_TYPE == _D2_DP_PORT)) == 2)
#define _DP_EMBEDDED_SWITCH_SUPPORT_TYPE            _DP_EMBEDDED_SWITCH_2_DP
#else
...
#if(_OUTPUT_TYPE_PATH == _DP_TX_1_PATH)
#define _EMBEDDED_DP_TX_PORT_0                      _OFF
#define _EMBEDDED_DP_TX_PORT_1                      _OFF
#define _EMBEDDED_DP_TX_PORT_2                      _OFF
#define _EMBEDDED_DP_TX_PORT_3                      _ON
#elif(_OUTPUT_TYPE_PATH == _DP_TX_2_PATH)
#define _EMBEDDED_DP_TX_PORT_0                      _ON
#define _EMBEDDED_DP_TX_PORT_1                      _OFF
#define _EMBEDDED_DP_TX_PORT_2                      _ON
#define _EMBEDDED_DP_TX_PORT_3                      _OFF
#elif(_OUTPUT_TYPE_PATH == _DP_TX_4_PATH)
#define _EMBEDDED_DP_TX_PORT_0                      _ON
#define _EMBEDDED_DP_TX_PORT_1                      _ON
#define _EMBEDDED_DP_TX_PORT_2                      _ON
#define _EMBEDDED_DP_TX_PORT_3                      _ON
#else
#define _EMBEDDED_DP_TX_PORT_0                      _OFF
...
#define _EMBEDDED_DP_TX_PORT_3                      _OFF
#endif
#elif(_SCALER_TYPE == _RL6478_SERIES)
#if(_OUTPUT_TYPE_PATH == _DP_TX_2_PATH)
#define _EMBEDDED_DP_TX_PORT_0                      _ON
#define _EMBEDDED_DP_TX_PORT_1                      _ON
#define _EMBEDDED_DP_TX_PORT_2                      _OFF
#define _EMBEDDED_DP_TX_PORT_3                      _OFF
...
#if((_EMBEDDED_DP_TX_PORT_0 == _ON) || (_EMBEDDED_DP_TX_PORT_1 == _ON) || (_EMBEDDED_DP_TX_PORT_2 == _ON) || (_EMBEDDED_DP_TX_PORT_3 == _ON))
#define _EMBEDDED_DP_TX_SUPPORT                     _ON
#else
#define _EMBEDDED_DP_TX_SUPPORT                     _OFF
#endif
...
#if((_D1_INPUT_PORT_TYPE == _D1_HDMI_PORT) || (_D1_INPUT_PORT_TYPE == _D1_MHL_PORT))
#if((_HW_HDMI_2_0_SUPPORT_PORT == _HDMI_2_0_D0_D1) || (_HW_HDMI_2_0_SUPPORT_PORT == _HDMI_2_0_D1_D2_D3) || (_HW_HDMI_2_0_SUPPORT_PORT == _HDMI_2_0_D1_D2))
#define _D1_HDMI_2_0_SUPPORT                        _ON
#endif
#endif

#if((_D2_INPUT_PORT_TYPE == _D2_HDMI_PORT) || (_D2_INPUT_PORT_TYPE == _D2_MHL_PORT))
#if((_HW_HDMI_2_0_SUPPORT_PORT == _HDMI_2_0_D2_D3_D4_D5) || (_HW_HDMI_2_0_SUPPORT_PORT == _HDMI_2_0_D1_D2_D3) ||\
    (_HW_HDMI_2_0_SUPPORT_PORT == _HDMI_2_0_D2_D3) || (_HW_HDMI_2_0_SUPPORT_PORT == _HDMI_2_0_D2) ||\
...
//--------------------------------------------------
#if((_D0_DP_TYPE_C_PORT_CTRL_TYPE == _RTS5400_SERIES) || (_D1_DP_TYPE_C_PORT_CTRL_TYPE == _RTS5400_SERIES) || (_D1_DP_TYPE_C_PORT_CTRL_TYPE == _RTS5400_SERIES) || (_D6_DP_TYPE_C_PORT_CTRL_TYPE == _RTS5400_SERIES) ||\
    (_D0_DP_TYPE_C_USB_HUB_TYPE == _RTS5411_SERIES) || (_D1_DP_TYPE_C_USB_HUB_TYPE == _RTS5411_SERIES) || (_D2_DP_TYPE_C_USB_HUB_TYPE == _RTS5411_SERIES) || (_D6_DP_TYPE_C_USB_HUB_TYPE == _RTS5411_SERIES))
...
//--------------------------------------------------
#if((_D0_DP_TYPE_C_PORT_CTRL_TYPE == _RTS5400_SERIES) || (_D1_DP_TYPE_C_PORT_CTRL_TYPE == _RTS5400_SERIES) || (_D1_DP_TYPE_C_PORT_CTRL_TYPE == _RTS5400_SERIES) || (_D6_DP_TYPE_C_PORT_CTRL_TYPE == _RTS5400_SERIES))
#define _PORT_CONTROLLER_RTS5400_SERIES_SUPPORT     _ON
#else
#define _PORT_CONTROLLER_RTS5400_SERIES_SUPPORT     _OFF
#endif

#if((_D0_DP_TYPE_C_PORT_CTRL_TYPE == _EMBEDDED) || (_D1_DP_TYPE_C_PORT_CTRL_TYPE == _EMBEDDED) || (_D1_DP_TYPE_C_PORT_CTRL_TYPE == _EMBEDDED) || (_D6_DP_TYPE_C_PORT_CTRL_TYPE == _EMBEDDED))
#define _PORT_CONTROLLER_EMBEDDED_SUPPORT           _ON
#else
#define _PORT_CONTROLLER_EMBEDDED_SUPPORT           _OFF
#endif

#if((_D0_DP_TYPE_C_PORT_CTRL_TYPE == _PORT_CONTOLLER_USER) || (_D1_DP_TYPE_C_PORT_CTRL_TYPE == _PORT_CONTOLLER_USER) || (_D1_DP_TYPE_C_PORT_CTRL_TYPE == _PORT_CONTOLLER_USER) || (_D6_DP_TYPE_C_PORT_CTRL_TYPE == _PORT_CONTOLLER_USER))
...
#if(_D2_DP_CONNECTOR_TYPE == _DP_CONNECTOR_TYPEC)
#define _D2_DP_TYPE_C_SUPPORT                       _ON
#else
#define _D2_DP_TYPE_C_SUPPORT                       _OFF
#endif
...
#if((_D0_DP_TYPE_C_SUPPORT == _ON) || (_D1_DP_TYPE_C_SUPPORT == _ON) || (_D2_DP_TYPE_C_SUPPORT == _ON) || (_D6_DP_TYPE_C_SUPPORT == _ON))
...
//--------------------------------------------------
#if((_D0_DP_TYPE_C_USB_HUB_TYPE == _USB_HUB_USER) || (_D1_DP_TYPE_C_USB_HUB_TYPE == _USB_HUB_USER) || (_D2_DP_TYPE_C_USB_HUB_TYPE == _USB_HUB_USER) || (_D6_DP_TYPE_C_USB_HUB_TYPE == _USB_HUB_USER))
...
#if(_D2_DP_TYPE_C_USB_HUB_TYPE != _USB_HUB_NONE)
#define _D2_DP_USB_HUB_SUPPORT                      _ON
#else
#define _D2_DP_USB_HUB_SUPPORT                      _OFF
#endif
...
#if((_D0_DP_USB_HUB_SUPPORT == _ON) || (_D1_DP_USB_HUB_SUPPORT == _ON) || (_D2_DP_USB_HUB_SUPPORT == _ON) || (_D6_DP_USB_HUB_SUPPORT == _ON))
