...
/////////////
#define    _TEST          _OFF
#define  _HDMI_ULTRA_HDR_SUPPORT   _ON

#define _DP_ULTRA_HDR_SUPPORT                                   _OFF
//--------------------------------------------------
// Pcb Option
//--------------------------------------------------
#define _PCB_TYPE                                      _RL6193_JY96F_1DP1HDMI1DUALDVI_R10_1_DPTX_LVDS_VB1//      _RL6193_SG_SG96E_1DP2HDMI1DUALDVI_R10_1_DPTX_LVDS_VB1//  _RL6193_JY96CD_1DP4HDMI_WS_DPTX_LVDS_VB1// _RL6193_DEMO_D_1A1H4MHL1DP_DPTX_LVDS_VB1

//--------------------------------------------------
// Panel Option
//--------------------------------------------------
#define _PANEL_TYPE                                             _AUO_M270DAN02_8CH_LVDS
...
#define _OSD_HHT                        _ON//_OFF // 


#define _NONE_LOGO												0   // 
#define _RTD_LOGO												1   // REALTEK
#define _DNA_LOGO											2   // 完美
#define _NEWSKILL_LOGO											3   // 完美


#define _OSD_LOGO_TYPE               _NONE_LOGO// _NEWSKILL_LOGO//     _DNA_LOGO//    _NONE_LOGO



#define _OSD_AUDIO_SUPPORT                    _ON
///////////
// DDCCI //
///////////
...
//-------------------------------------------------
#define _HDCP_1_4_KEY_LOCATION                               _TABLE_LOCATION_CODE//   _TABLE_LOCATION_SYSTEM_EEPROM
...
//--------------------------------------------------
#define _OOR_H_FREQ_UPPER_BOUND                                 2550 // Unit in 0.1 kHZ
#define _OOR_H_FREQ_LOWER_BOUND                                 100  // Unit in 0.1 kHZ
#define _OOR_V_FREQ_UPPER_BOUND                                 1800 // Unit in 0.1 HZ
...
#define _FAIL_SAVE_H_FREQ_UPPER_BOUND                           2550 // Unit in 0.1 kHZ
#define _FAIL_SAVE_H_FREQ_LOWER_BOUND                           110  // Unit in 0.1 kHZ
#define _FAIL_SAVE_V_FREQ_UPPER_BOUND                           1800 // Unit in 0.1 HZ
#define _FAIL_SAVE_V_FREQ_LOWER_BOUND                           230  // Unit in 0.1 HZ

#define _INPUTCLOCK_RANG_VGA                                    2100 // Unit in 0.1 MHz
#define _INPUTCLOCK_RANG_DVI                                    3600 // Unit in 0.1 MHz
#define _INPUTCLOCK_RANG_HDMI                                   7500 // Unit in 0.1 MHz
#define _INPUTCLOCK_RANG_DP                                     7500 // Unit in 0.1 MHz
...
#define _AUDIO_HEADPHONE_SUPPORT    _OFF
//-------------------------------------------------
// Audio DAC Option
//-------------------------------------------------
...
#define _LINE_IN_VOLUME_MAX                                   0x1fff //   0x3FFF                      // MAX: 0x3FFF
...
#define _DIGITAL_VOLUME_MAX                                   0x1fff//  0x3FFF                      // MAX: 0x3FFF
