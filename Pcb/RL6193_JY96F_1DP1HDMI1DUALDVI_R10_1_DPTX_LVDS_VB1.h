...
/********************************************************************************/
//----------------------------------------------------------------------------------------------------
// ID Code      : RL6193_SG_SG96E_1DP2HDMI1DUALDVI_R10_1_DPTX_LVDS_VB1.h No.0000
// Update Note  :
//----------------------------------------------------------------------------------------------------
#if(_PCB_TYPE == _RL6193_JY96F_1DP1HDMI1DUALDVI_R10_1_DPTX_LVDS_VB1)
...
#define _D3_EMBEDDED_DDCRAM_SIZE                _EDID_SIZE_128
#define _D3_EMBEDDED_DDCRAM_LOCATION            _EDID_TABLE_LOCATION_CODE
#define _PORT_D3         tSTRING_DVI

//--------------------------------------------------
// D4 Input Port
//--------------------------------------------------
#define _D4_INPUT_PORT_TYPE                     _D4_NO_PORT//_D4_HDMI_PORT
...
#define _D6_DDC_CHANNEL_SEL                     _NO_DDC
...
#define _LVDS_PORT_MIRROR                     	_PNL_LVDS_PORT_MIRROR 
#define _LVDS_PORT_LMIRROR                     	_PNL_LVDS_PORT_LMIRROR 
#define _LVDS_PORT_HL_MIRROR                    _PNL_LVDS_PORT_HL_MIRROR

#define _LVDS_PORT_AB_SWAP                    	_PNL_LVDS_PORT_AB_SWAP  
#define _LVDS_PORT_CD_SWAP                    	_PNL_LVDS_PORT_CD_SWAP  
#define _LVDS_PORT_EF_SWAP                    	_PNL_LVDS_PORT_EF_SWAP  
#define _LVDS_PORT_GH_SWAP                    	_PNL_LVDS_PORT_GH_SWAP  
#define _LVDS_PN_SWAP                         	_PNL_LVDS_PN_SWAP       
#endif
//--------------------------------------------------
// LVDS Driving Config
//--------------------------------------------------
...
#define _PANEL_DPTX_1_1_LANE_PN_SWAP         _DISABLE//  _DISABLE// _DISABLE
...
//--------------------------------------------------
#define _PANEL_DPTX_1_2_SWING_LEVEL             _DP_SWING_600_MV
...
#define _DDR3_PLL_INITIAL_PHASE_0             0xD001B00 // 0x180A2000//0x17022300
#define _DDR3_PLL_INITIAL_PHASE_1             0x22001B0D//  0x18002619//0x18002316
#define _DDR3_READ_DQ_DLYN_TAP               0x23232323//   0x22222222//0x21212121
...
// VGA_CABLE_DET
#define _PIN_AJ2                                (2 & 0x07) // Page 10-0x17[2:0]
...
// VBUS_EN_2 // NC
#define _PIN_AD29                                 (1 & 0x07)//(0 & 0x07) // Page 10-0x3C[2:0]
// 0 ~ 6 (0: P9D4i<I>, 1: P9D4o<PP>, 2: P9D4o<OD>, 3: PWM4<PP>, 4: PWM4<OD>,
//        5: TCON[6], 6:T1)

// NC
#define _PIN_AF29                                 (2 & 0x07) // Page 10-0x3D[2:0]
// 0 ~ 6 (0: P9D5i<I>, 1: P9D5o<PP>, 2: P9D5o<OD>, 3: PWM3<PP>, 4: PWM3<OD>,
//        5: TCON[5], 6:T2)

//  IR_IN
#define _PIN_AB29                                 (2 & 0x07) // Page 10-0x3E[2:0]
...
// HDMI_HOT_PLUG_1
#define _PIN_AK3                                  (1 & 0x07) // Page 10-0x57[2:0]
// 0 ~ 2 (0: PCD7i<I>, 1: PCD7o<PP>, 2: PCD7o<OD>)

// DP_HOT_PLUG
#define _PIN_AK4                                  (1 & 0x07) // Page 10-0x58[2:0]
// 0 ~ 2 (0: PDD0i<I>, 1: PDD0o<PP>, 2: PDD0o<OD>)

// HDMI_HOT_PLUG_1
#define _PIN_AJ3                                  (1 & 0x07) // Page 10-0x59[2:0]
// 0 ~ 2 (0: PDD1i<I>, 1: PDD1o<PP>, 2: PDD1o<OD>)

// HDMI_HOT_PLUG_2
#define _PIN_AJ4                                  (1 & 0x07) // Page 10-0x5A[2:0]
...
// AMPMUTE
#define _PIN_AH4                                  (2 & 0x07) // Page 10-0x5C[2:0]
// 0 ~ 2 (0: PDD4i<I>, 1: PDD4o<PP>, 2: PDD4o<OD>)

// AMP_MUTE // AUDIO_SCL
#define _PIN_AG3                                  (2 & 0x07)//(6 & 0x07) // Page 10-0x5D[2:0]
// 0 ~ 6 (0: PDD5i<I>, 1: PDD5o<PP>, 2: PDD5o<OD>, 3: PWM1<PP>, 4: PWM1<OD>,
//        5:TCON[7], 6:IICSCL2)

// AMP_VOL // AUDIO_SDA
#define _PIN_AG4                                  (2 & 0x07)//(6 & 0x07) // Page 10-0x5E[2:0]
...
// 0 ~ 3 (0: PED7i<I>, 1: PED7o<PP>, 2: PED7o<OD>, 3: Cec1_line_pio_in)

// CEC0
#define _PIN_K7                                   (3 & 0x07) // Page 10-0x68[2:0]
// 0 ~ 3 (0: PFD0i<I>, 1: PFD0o<PP>, 2: PFD0o<OD>, 3: Cec0_line_pio_in)
...
#define _SG_TEST_LAMP                 _ON

#if(_SG_TEST_LAMP== _ON) //ËÉ¹ÚµÆÐ§²âÊÔ

#define GPIO_FLASH_SCL                         ( MCU_FE4D_PORTD5_PIN_REG ) //SCL  1:hight 0:low   AG3
#define GPIO_FLASH_SDA                          (MCU_FE4E_PORTD6_PIN_REG) //SDA _ 1:hight 0:low  AG4
#define GPIO_FLASH_ON_OFF                       (MCU_FE4B_PORTD3_PIN_REG) //5V   1:low  0:hight   AH3

#define FLASH_GPIO_CONTROL_POWER(x)             {\
                                                }
...
#define OSD_LED_CONTRL(x)                       {\
	                                                GPIO_FLASH_ON_OFF = ~(_OSD_LED_OFF);\
	                                                GPIO_FLASH_SDA = (_OSD_LED_OFF);\
	                                                GPIO_FLASH_SCL = (_OSD_LED_OFF);\
                                                    GPIO_FLASH_ON_OFF = ~(x);\
...
//////////////////////////////////////////
// Power ON Region GPIO Initial Setting //
//////////////////////////////////////////
#define PCB_GPIO_ON_REGION_INITIAL_SETTING()    {\
                                                    ...
                                                    ScalerSetBit(P10_33_PIN_SHARE_CTRL83, ~(_BIT2 | _BIT1 | _BIT0), (BYTE)_PIN_AL15); \ 
                                                    SET_REGULATOR_5V_OUT(_REGULATOR_5V_OFF); \
                                                    PCB_LDEN_PIN(_LDEN_OFF);\
                                                }
...
#define PCB_GPIO_SETTING_POWER_NORMAL()         {\
                                                    ...
                                                    PCB_D3_EDID_EEPROM_WRITE_PROTECT(_EDID_EEPROM_WP_ENABLE); \                                                    
                                                    PCB_D4_EDID_EEPROM_WRITE_PROTECT(_EDID_EEPROM_WP_ENABLE); \
                                                    PCB_D0_MYDP_POWER(_MYDP_5V_POWER_ON);\
                                                }

#define PCB_GPIO_SETTING_POWER_SAVING()         {\
                                                    PCB_D0_MYDP_POWER(_MYDP_5V_POWER_OFF);\
...
//-----------------------------------------------
// Macro of DP1.2/MyDP Power Control
//-----------------------------------------------
sbit bD0_MYDP_POWER                                = P3 ^ 0; // Pin_AC6, P3.0
#define _MYDP_5V_POWER_ON                       1       // DP 5V power on
#define _MYDP_5V_POWER_OFF                      0       // DP 5V power off
...
//--------------------------------------------------
// Macro of LD_EN Power Up/Down
//--------------------------------------------------
#define bLDENPOWER                         (MCU_FE13_PORT63_PIN_REG) // Pin_AE6, P3.5

#define _LDEN_ON                       		1
#define _LDEN_OFF                  			0

#define PCB_LDEN_PIN(x)              {\
                                                    bLDENPOWER = (x);\
                                                }
//--------------------------------------------------
...
#define PCB_BACKLIGHT_POWER(x)                  {\
                                                    ...
                                                    {\
                                                        ...
                                                        ScalerMcuPwmAdjustFrequency(_BACKLIGHT_PWM, (((DWORD)_PANEL_TYP_FRAME_RATE * 27) / 100));\
                                                    }\
                                                    else\
                                                    {\
...
//-----------------------------------------------
#define bEDID_WRITE_PROTECT                     (MCU_FE31_PORTA1_PIN_REG)// _PIN_AG28, PA.1
...
//-----------------------------------------------
#define bD0_DP_PIN15_CONNECT                       (MCU_FE33_PORTA3_PIN_REG)   // Pin_AH28, PA.3 D0->DP DP_SINK_ASS_P1
#define bD0_DP_PIN16_CONNECT                       (MCU_FE35_PORTA5_PIN_REG)   // Pin_AH27, PA.5 D0->DP DP_CABLE_DET_1
#define bD0_DP_PIN17_CONNECT                       (MCU_FE34_PORTA4_PIN_REG)   // Pin_AE29, PA.4 D0->DP DP_SINK_ASS_N1
#define GET_PCB_D0_DP_SOURCE_POWER()               (bD0_DP_PIN17_CONNECT)

#define bD1_DP_PIN15_CONNECT                       (MCU_EMPTY_PIN_ASSIGN_ADDRESS) // D1->HDMI 2.0 // (MCU_FE36_PORTA6_PIN_REG)   // Pin_AB28, PA.6
#define bD1_DP_PIN16_CONNECT                       (MCU_EMPTY_PIN_ASSIGN_ADDRESS) // D1->HDMI 2.0 (MCU_FE38_PORTB0_PIN_REG)   // Pin_AD28, PB.0
#define bD1_DP_PIN17_CONNECT                       (MCU_EMPTY_PIN_ASSIGN_ADDRESS) // D1->HDMI 2.0 // (MCU_FE37_PORTA7_PIN_REG)   // Pin_AH25, PA.7
#define GET_PCB_D1_DP_SOURCE_POWER()               (bD1_DP_PIN17_CONNECT)

#define bA0_CONNECT                             (MCU_EMPTY_PIN_ASSIGN_ADDRESS) // VGA NO PORT  // (MCU_FE07_PORT47_PIN_REG)      // Pin_AJ2, P4.7
#define bD0_CONNECT                             (((bit)bD0_DP_PIN15_CONNECT == _TRUE) && ((bit)bD0_DP_PIN16_CONNECT == _TRUE) && ((bit)bD0_DP_PIN17_CONNECT == _FALSE))
#define bD1_CONNECT                             (MCU_FE39_PORTB1_PIN_REG) // D1 ->HDMI 2.0    (((bit)bD1_DP_PIN15_CONNECT == _TRUE) && ((bit)bD1_DP_PIN16_CONNECT == _TRUE) && ((bit)bD1_DP_PIN17_CONNECT == _FALSE))
#define bD2_CONNECT                             (MCU_FE3B_PORTB3_PIN_REG) // D2 ->HDMI 1.4  Pin_AC29, PB.2
#define bD3_CONNECT                             (MCU_FE3A_PORTB2_PIN_REG) // D3->NC // (MCU_FE39_PORTB1_PIN_REG)      // Pin_AH26, PB.1
#define bD4_CONNECT                             (MCU_EMPTY_PIN_ASSIGN_ADDRESS)      // _Pin_AG7, PC.6
#define bD5_CONNECT                             (MCU_EMPTY_PIN_ASSIGN_ADDRESS)
#define bD6_CONNECT                             (MCU_EMPTY_PIN_ASSIGN_ADDRESS)

#define PCB_A0_PIN()                            (SET_A0_CABLE_STATUS(!bA0_CONNECT))
#define PCB_D0_PIN()                            (SET_D0_CABLE_STATUS(bD0_CONNECT))
#define PCB_D1_PIN()                            (SET_D1_CABLE_STATUS(!bD1_CONNECT)) //D1 ->HDMI 2.0 and D1 no multiplex MHL,  D1 !->DP 
#define PCB_D2_PIN()                            (SET_D2_CABLE_STATUS((!bD2_CONNECT)  ))  //D2 ->HDMI 1.4  and D2 multiplex MHL  
#define PCB_D3_PIN()                            (SET_D3_CABLE_STATUS((!bD3_CONNECT) )) // D2 NO PORT
#define PCB_D4_PIN()                            (SET_D4_CABLE_STATUS(!bD4_CONNECT))
#define PCB_D5_PIN()                            (SET_D5_CABLE_STATUS(!bD5_CONNECT))
#define PCB_D6_PIN()                            (SET_D6_CABLE_STATUS(!bD6_CONNECT))
...
//-----------------------------------------------
#define bD0_HPD                                 (MCU_FE48_PORTD0_PIN_REG) // Pin_AK4, PD.0
#define bD1_HPD                                 (MCU_FE49_PORTD1_PIN_REG) // Pin_AJ3, PD.1
#define bD2_HPD                                 (MCU_FE4A_PORTD2_PIN_REG) // Pin_AJ4, PD.2
#define bD3_HPD                                 (MCU_FE47_PORTC7_PIN_REG) // Pin_AK3, PC.7
#define bD4_HPD                                ( MCU_EMPTY_PIN_ASSIGN_ADDRESS)//(MCU_FE4B_PORTD3_PIN_REG) // Pin_AH3, PD.3
...
#define PCB_PWM_SETTING()                       {\
                                                    ScalerMcuPwmAdjustFrequency(_BACKLIGHT_PWM, 160);\
                                                }
...
//_IIC_FOR_VGA
#define bDDCVGAIICSCL                           (MCU_EMPTY_PIN_ASSIGN_ADDRESS) //_IIC_FOR_VGA// _PIN_AG2
#define bDDCVGAIICSDA                       	(MCU_EMPTY_PIN_ASSIGN_ADDRESS)  //_IIC_FOR_VGA// _PIN_AG1

//_IIC_FOR_DDC0
#define bDDC0IICSCL                              (MCU_EMPTY_PIN_ASSIGN_ADDRESS); // _PIN_
#define bDDC0IICSDA                              (MCU_EMPTY_PIN_ASSIGN_ADDRESS); // _PIN_

//_IIC_FOR_DDC1
#define bDDC1IICSCL                              P1_0 // _PIN_AA7
#define bDDC1IICSDA                              P1_1 // _PIN_AA6
...
//DUAL -LINK NEED 2 DDCSCL && DDCSDA
//_IIC_FOR_DDC4
#define bDDC4IICSCL                             (MCU_FE51_PORTE1_PIN_REG)   // PIN_K6
#define bDDC4IICSDA                             (MCU_FE52_PORTE2_PIN_REG)  // PIN_K5

//DUAL -LINK
//_IIC_FOR_DDC5
#define bDDC5IICSCL                             (MCU_EMPTY_PIN_ASSIGN_ADDRESS)   // PIN_J6 
#define bDDC5IICSDA                             (MCU_EMPTY_PIN_ASSIGN_ADDRESS)   // PIN_J5
...
//_IIC_FOR_SENSOR
#define bSENSORI2CSCL                               (MCU_EMPTY_PIN_ASSIGN_ADDRESS)  
#define bSENSORI2CSDA                               (MCU_EMPTY_PIN_ASSIGN_ADDRESS) 


#define _ON_LINE_EDID_NON         		0
#define _ON_LINE_EDID_A0             	1
#define _ON_LINE_EDID_D0             	2
#define _ON_LINE_EDID_D1             	3
#define _ON_LINE_EDID_D2              	4
#define _ON_LINE_EDID_D3             	5
#define _ON_LINE_EDID_D4             	6
#define _ON_LINE_EDID_D5             	7
#define _ON_LINE_EDID_D6             	8
...
#define bLED1                                   (MCU_FE03_PORT43_PIN_REG) // Pin_AM1, P4.4
#define bLED2                                   (MCU_FE04_PORT44_PIN_REG) // Pin_AM2, P4.3
#else
#define bLED1                                 (MCU_FE04_PORT44_PIN_REG) // Pin_AM2, P4.3
#define bLED2                                  (MCU_FE03_PORT43_PIN_REG) // Pin_AM1, P4.4   
#endif
...
//-----------------------------------------------
// Macro of Audio Setting
//-----------------------------------------------


#define PCB_AUDIO_VOLUME_PWM(x)                 {\
                                                    MCU_FF4A_PWM0H_DUT = x;         \
                                                }

#define PCB_GET_AUDIO_VOLUME_PWM()              (MCU_FF4A_PWM0H_DUT)
...
#define bPOWER_KEY                   ( MCU_FE0B_PORT53_PIN_REG)
...
//-----------------------------------------------
#define bHeadphoneDetect                        (MCU_FE46_PORTC6_PIN_REG) // _PIN_AG7====>PCD6i(I) 
...
//-----------------------------------------------
#define bPCBAMPMUTECONTROL                      (MCU_FE4C_PORTD4_PIN_REG) // _PIN_AH4  ,PDD4o
...
//-----------------------------------------------
#define bPCBAMPSDCONTROL                     (MCU_EMPTY_PIN_ASSIGN_ADDRESS) // _PIN_AH4  ,PDD4o
...
#endif // End of #if(_PCB_TYPE == _RL6193_JY96F_1DP1HDMI1DUALDVI_R10_1_DPTX_LVDS_VB1)
