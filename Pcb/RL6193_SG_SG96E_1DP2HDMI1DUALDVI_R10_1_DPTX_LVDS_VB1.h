...
#if(_PCB_TYPE == _RL6193_SG_SG96E_1DP2HDMI1DUALDVI_R10_1_DPTX_LVDS_VB1)
...
//--------------------------------------------------
#define _DDCCI_VGA_1                                      _A0_INPUT_PORT
#define _DDCCI_DVI_1                                      _NO_INPUT_PORT
#define _DDCCI_DVI_2                                      _NO_INPUT_PORT
#define _DDCCI_DP_1                                       _D0_INPUT_PORT
#define _DDCCI_DP_2                                       _NO_INPUT_PORT
#define _DDCCI_HDMI_1                                     _D1_INPUT_PORT
#define _DDCCI_HDMI_2                                     _D2_INPUT_PORT
...
#define _DDR3_PLL_INITIAL_PHASE_0               0x180A2000//0x17022300
#define _DDR3_PLL_INITIAL_PHASE_1               0x18002619//0x18002316
#define _DDR3_READ_DQ_DLYN_TAP                  0x22222222//0x21212121
...
// AMP_VOL // AUDIO_SDA
#define _PIN_AG4                                  (4 & 0x07)//(6 & 0x07) // Page 10-0x5E[2:0]
...
#define bD4_CONNECT                             (MCU_FE46_PORTC6_PIN_REG)      // Pin_AG7, PC.6
...
#define PCB_SW_IIC_SDA_SET()                    {\
                                                    ...
                                                    else if(GET_SW_IIC_STATUS() == _IIC_DDC1)	\
                                                    {												\
                                                    	bDDC1IICSDA = _TRUE;						\
                                                    }												\
...
#define PCB_KEY_STATE(ucV0, ucV1, ucV2, ucV3, ucKeyState)   {\
                                                                if((0 <= ucV2) && (ucV2 < 0x30))       \
                                                                    ucKeyState |= _POWER_KEY_MASK;      \
                                                                                                       \
                                                                if((0x30 <= ucV2) && (ucV2 < 0x60))    \
                                                                    ucKeyState |= _LEFT_KEY_MASK; \
                                                                                                       \
                                                                if((0x60 <= ucV2) && (ucV2 < 218))    \
                                                                    ucKeyState |= _RIGHT_KEY_MASK;    \
                                                                                                       \
                                                                if((0x10 <= ucV1) && (ucV1 < 0x30))    \
                                                                    ucKeyState |=_MENU_KEY_MASK ;      \
                                                                                            \
                                                                if((0x30 <= ucV1) && (ucV1 < 0x60))    \
...
//-----------------------------------------------
#define bHeadphoneDetect                        (MCU_FE46_PORTC6_PIN_REG) // _PIN_AG7====>PC6(I) 
...
//-----------------------------------------------
#define bPCBAMPMUTECONTROL                      (MCU_FE4D_PORTD5_PIN_REG) // Pin_AG3 PD5 
...
#define bPCBAMPSDCONTROL                     (MCU_FE4D_PORTD5_PIN_REG) // AG3 PD5  
...
#endif // End of #if(_PCB_TYPE == _RL6193_SG_SG96E_1DP2HDMI1DUALDVI_R10_1_DPTX_LVDS_VB1)
